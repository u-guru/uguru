<div class="pf-container pf-tech">
    <aside class="pf-aside">
        ...
        <div class="pf-aside-widget">
            ...
            <button class="bg-tech normal">Contact Guru</button>
        </div>
        ...
        <main class="pf-main">
            <div class="pf-profile pf-main-section active">
                ...
                <ul class="pf-items">
                    ...
                    <li>
                        <div class="pf-tile bg-tech">
                            <div class="pf-tile-top" style="background-image: url('https://c2.staticflickr.com/4/3169/2988420535_5acf01b064_z.jpg?zz=1');">
                                <div class="pf-pricing">$10/hr</div>
                            </div>
                            <div class="pf-tile-bottom">
                                <h1>Memory Backup</h1>
                ...
                <ul class="pf-items">
                    ...
                    <li>
                        <div class="pf-cardlet highlight bg-tech">
                <div class="pf-cardlet-front" style="background-image: url('http://g02.a.alicdn.com/kf/HTB1VrT_IFXXXXbAXXXXq6xXFXXXD/Free-shipping-New-100-High-Quality-AC-Power-Adapter-US-Plug-Extension-Cord-1-8M-6ft.jpg');"></div>
                <div class="pf-cardlet-back"></div>
                <div class="pf-cardlet-bottom">
                    <h1>How to Spot Fake Chargers</h1>
                    <div>
                        <h2>03/28/2016</h2>
                    </div>
                </div>
            ...
            <div class="pf-portfolio pf-main-section">
                ...
                <ul class="pf-items">
                    ...
                    <li>
                        <div class="pf-tile bg-tech">
                            <div class="pf-tile-top" style="background-image: url('http://www.imore.com/sites/imore.com/files/images/stories/2011/04/white_iphone_ipad-052.jpg');">
                                <div class="pf-pricing">$10/hr</div>
                            </div>
                            <div class="pf-tile-bottom">
                    ...
                    <li>
                        <div class="pf-tile bg-tech">
                            <div class="pf-tile-top" style="background-image: url('http://thewirecutter.com/wp-content/uploads/2015/09/14-wifi-router-finalist-group-630.jpg');">
                                <div class="pf-pricing">$10/hr</div>
                            </div>
                            <div class="pf-tile-bottom">
