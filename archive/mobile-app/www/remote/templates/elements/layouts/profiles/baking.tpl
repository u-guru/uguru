<div class="pf-container pf-baking">
    <aside class="pf-aside">
        <div class="pf-aside-bg" style="background-image: url('https://ramisayar.com/assets/unsplash_52d5bbef8a613_1.jpg');"></div>
        <div class="pf-aside-widget">
            ...
            <button class="bg-baking normal">Contact Guru</button>
        </div>
        <div class="pf-aside-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
    ...
    <div class="pf-rest">
        <nav class="pf-tabs tab-bar slide">
            <div>
                <a class="pf-profile-section-link pf-main-link active">Profile</a>
                <a class="pf-portfolio-section-link pf-main-link">Services</a>
                <a class="pf-about-section-link pf-main-link">About</a>
                <a class="pf-resources-section-link pf-main-link">Resources</a>
                <hr/>
            </div>
        </nav>
        <main class="pf-main">
            <div class="pf-profile pf-main-section active">
                <div class="pf-main-header">
                    <h1>Gabri’s Quality Treats</h1>
                ...
                <ul class="pf-items">
                    ...
                    <li>
                        <div class="pf-tile bg-baking">
                            <div class="pf-tile-top" style="background-image: url('https://scontent.cdninstagram.com/t51.2885-15/s640x640/sh0.08/e35/12357659_858791757567285_286319730_n.jpg?ig_cache_key=MTEzOTM1NTA4NTcxNTIwMDQzMw%3D%3D.2');">
                                <div class="pf-pricing">$10/dozen</div>
                            </div>
                            <div class="pf-tile-bottom">
                                <h1>Cranberry Tea Cookies</h1>
                            </div>
                        </div>
                    </li>
                </ul>
                ...
                <ul class="pf-items">
                    <li>
                        <div class="pf-cardlet bg-baking">
                    ...
                    <li>
                        <div class="pf-cardlet bg-baking highlight">
                            <div class="pf-cardlet-front"></div>
                            <div class="pf-cardlet-back" style="background: url('https://elanaspantry.com/wp-content/uploads/2010/05/gluten-free-coconut-cupcakes-key-lime-frosting-DSC_53281.jpg');"></div>
                            <div class="pf-cardlet-bottom">
                                <div class="pf-cardlet-icon" style="background-image: url('https://elanaspantry.com/wp-content/uploads/2010/05/gluten-free-coconut-cupcakes-key-lime-frosting-DSC_53281.jpg');"></div>
                                <h1>100 Cupcakes in 100 Minutes</h1>
                                <div>
                                    <h2>03/28/2016</h2>
                                </div>
                            </div>
            ...
            <div class="pf-portfolio pf-main-section">
                <div class="pf-main-header">
                    <h1>Gabri’s Quality Treats</h1>
                    <p>Fusce vehicula dolor arcu, sit amet blandit dolor nec. Donec viverra.<p>
                </div>
                <ul class="pf-items">
                    ...
                    <li>
                        <div class="pf-tile bg-baking">
                            <div class="pf-tile-top" style="background-image: url('https://scontent.cdninstagram.com/l/t51.2885-15/s640x640/sh0.08/e35/12328358_520375411458673_888561253_n.jpg?ig_cache_key=MTEyOTQ0NDAwNTQ2NzU3Njg1MQ%3D%3D.2');">
                                <div class="pf-pricing">$10/dozen</div>
                            </div>
                            <div class="pf-tile-bottom">
                                <h1>Raspberry Lemon Bars</h1>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="pf-tile bg-baking">
                            <div class="pf-tile-top" style="background-image: url('https://scontent.cdninstagram.com/t51.2885-15/s640x640/sh0.08/e35/12237394_1515637408729443_514405960_n.jpg?ig_cache_key=MTEyNzkzNzU2MDg4MDI3MzU5NA%3D%3D.2');">
                                <div class="pf-pricing">$10/dozen</div>
                            </div>
                            <div class="pf-tile-bottom">
                                <h1>Yoghurt Vanilla Fruit Tart</h1>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="pf-tile bg-baking">
                            <div class="pf-tile-top" style="background-image: url('https://scontent.cdninstagram.com/t51.2885-15/s640x640/sh0.08/e35/11910114_513415332149646_1680444106_n.jpg?ig_cache_key=MTA1OTYyMDk3ODE5ODc2MzU4Ng%3D%3D.2');">
                                <div class="pf-pricing">$10/dozen</div>
                            </div>
                            <div class="pf-tile-bottom">
                                <h1>Blueberry Coconut Bars</h1>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="pf-tile bg-baking">
                            <div class="pf-tile-top" style="background-image: url('https://scontent.cdninstagram.com/t51.2885-15/s640x640/sh0.08/e35/11848959_523608901138752_1494462339_n.jpg?ig_cache_key=MTA1NzM3Nzg4NDQwOTYxNjc3Mw%3D%3D.2');">
                                <div class="pf-pricing">$10/dozen</div>
                            </div>
                            <div class="pf-tile-bottom">
                                <h1>Raspberry Orange Donut Cakes</h1>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="pf-tile bg-baking">
                            <div class="pf-tile-top" style="background-image: url('https://scontent.cdninstagram.com/t51.2885-15/s640x640/sh0.08/e35/11287822_1649263031954251_87451792_n.jpg?ig_cache_key=MTAyNzY4MjA2NzE3NjQxMzk0NQ%3D%3D.2');">
                                <div class="pf-pricing">$10/dozen</div>
                            </div>
                            <div class="pf-tile-bottom">
                                <h1>Apple Cake</h1>
                    ...
                    <li>
                        <div class="pf-tile bg-baking">
                            <div class="pf-tile-top" style="background-image: url('https://scontent.cdninstagram.com/t51.2885-15/s640x640/sh0.08/e35/11386514_1078447995507780_1205725800_n.jpg?ig_cache_key=MTAyNDg2ODMxNjY4NTQ1NzQyMQ%3D%3D.2');">
                                <div class="pf-pricing">$10/dozen</div>
                            </div>
                            <div class="pf-tile-bottom">
                                <h1>Raspberry Lime Bundt Cakes</h1>
                            </div>
                        </div>
                    </li>
                </ul>
            </div>
            <div class="pf-about pf-main-section">
                <div class="pf-main-header">
                    <h1>Gabri’s Quality Treats</h1>
                    <p>Fusce vehicula dolor arcu, sit amet blandit dolor nec. Donec viverra.<p>
                </div>
                <div class="pf-about-section">
                    ...
                    <div>
                        <h1>I am a freshman seeking a degree in Journalism.</h1>
                        <h2>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</h2>
                    </div>
                </div>
                <div class="pf-about-links pf-about-section">
            ...
            <div class="pf-resources pf-main-section">
                <div class="pf-main-header">
                    <h1>Gabri’s Quality Treats</h1>
                    <p>Fusce vehicula dolor arcu, sit amet blandit dolor nec. Donec viverra.<p>
                </div>
