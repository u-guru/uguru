	...
	<ul class="pf-card-stack slate">
		<li init-with="tr:[translateY:-30px, scale:(0.8,0.8,0.8)]">
				<div style="min-width: 300px"
					...
					on-init="t-enter"
					on-enter="a:[back-stack:set:(dur:1000ms#func:linear):in:delay-600]">
		...
		<li init-with="tr:[translateY:-15px, scale:(0.9,0.9,0.9)]">
			<div style="min-width: 300px"
				init-with="p:[op:0, tro:center bottom]"
				on-init="t-enter"
				on-enter="a:[back-stack:set:(dur:1000ms#func:linear):in:delay-300]">
		...
		<li>
			<div style="min-width: 300px"
				init-with="p:[op:0, tro:center bottom]"
				on-init="t-enter"
				on-enter="a:[scoop-enter:set:(dur:800ms#func:linear):in]">
