...
describe('#Error Test Flow : Cancel phone confirmataion',function()
{
	...
	{
		it('Go to credibility',function()
		{
			guru.OpenCredibility();
		});
		it('Open phone section',function()
		{
			credibility.OpenCredibilityOptions(2);
		})
		it('Open phone confirmataion',function()
		{
			credibility.OpenOptionsButton(2);
		});		
		...
		{
			credibility.closePopUp();
		});

		it('Check popup is not present',function()
		{
