            ...
            return {
                ...
                link: function (scope, element, attrs, ngModel) {
                            ...
                            // '<ion-content class="has-header has-header">',
                                '<ion-list>',
                                    '<ion-item class="dark-bg">',
                                        '<input class="google-place-search" type="search" ng-model="searchQuery" placeholder="Enter an asdad, place or ZIP code">',
                                    '</ion-item',
                    ...
                    var popupPromise = $ionicTemplateLoader.compile({
                        template: POPUP_TPL,
                        scope: scope,
                        appendTo: document.getElementById('searchBoxDiv')
                    });
