...
var SpinningWheel = {
    ...
    open: function (parentDiv) {
        this.create(parentDiv);
    ...
    close: function () {
        this.swWrapper.style.webkitTransitionTimingFunction = 'ease-in';
        this.swWrapper.style.webkitTransitionDuration = '0ms';
    ...
    changeNonSelectedValuesToOpacity: function() {
         var index, count,
            i, l,
            keys = [], values = [];
    ...
    scrollStart: function (e) {
        ...
        var xPos = e.targetTouches[0].clientX - this.swSlots.offsetLeft - this.slotEl[0].slotWidth - 40;    // Clicked position minus left offset (should be 11px)
        // Find tapped slot
        var slot = 0;
    ...
    scrollEnd: function (e) {
        ...
        var current_values = this.getSelectedValues()
        return true;
    },
