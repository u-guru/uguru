...
CA_CERTS = os.path.join(
     os.path.dirname(os.path.abspath(__file__ )), "ca_certs.txt")

#httplib2.Http(disable_ssl_certificate_validation=True, ca_certs = "ca_certs.txt")#.request('https://www.odesk.com:443')
