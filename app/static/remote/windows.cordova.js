...
exports.load = function(callback) {
    ...
    if (pathPrefix === null) {
        console.log('Could not find windows.cordova.js script tag. Plugin loading may fail.');
        pathPrefix = '';
    }
    injectIfNecessary('cordova/plugin_list', pathPrefix + 'windows.cordova_plugins.js', function() {
