<div class="pf-container pf-household">
    <aside class="pf-aside">
        <div class="pf-aside-bg" style="background-image: url('http://www.kinfolk.com/wp-content/uploads/2014/03/Kinfolk_City-Guide-Glasswing-Seattle-58.jpg');"></div>
        <div class="pf-aside-widget">
            ...
            <button class="bg-household normal">Contact Guru</button>
        </div>
        ...
        <main class="pf-main">
            <div class="pf-profile pf-main-section active">
                ...
                <ul class="pf-items">
                    ...
                    <li>
                        <div class="pf-tile bg-household">
                            <div class="pf-tile-top" style="background-image: url('http://cdni.condenast.co.uk/1920x1280/d_f/food-blog-vogue-4-2jul14-pr_b.jpg')"></div>
                            <div class="pf-tile-bottom">
                                <div>
                ...
                <ul class="pf-items">
                    ...
                    <li>
                        <div class="pf-cardlet highlight bg-household">
                            <div class="pf-cardlet-front" style="background-image: url('http://blog.dubizzle.com/dubizzleyourhome/wp-content/uploads/sites/30/2014/08/retro_furniture_dubizzle.jpg');"></div>
                            <div class="pf-cardlet-back"></div>
                            <div class="pf-cardlet-bottom">
                                <h1>How to Make Your Ikea Furniture Look Expensive</h1>
                                <div>
                                    <h2>03/28/2016</h2>
                                </div>
                            </div>
            ...
            <div class="pf-portfolio pf-main-section">
                ...
                <ul class="pf-items">
                    ...
                    <li>
                        <div class="pf-tile bg-household">
                            <div class="pf-tile-top" style="background-image: url('http://farm6.static.flickr.com/5146/5812063940_76210ec409_z.jpg')"></div>
                            <div class="pf-tile-bottom">
                                <div>
                                    <h1>Laundry</h1>
                                    <ul class="rating-stars" data-rating="4" data-half="true">
                    ...
                    <li>
                        <div class="pf-tile bg-household">
                            <div class="pf-tile-top" style="background-image: url('http://www.unclebobs.com/blog/wp-content/uploads/2013/04/UB-Organizing-Cleaning-Supplies-Pic-1-837x500.jpg')"></div>
                            <div class="pf-tile-bottom">
                                <div>
