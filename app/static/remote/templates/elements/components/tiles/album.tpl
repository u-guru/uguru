<a class="album-tile">
    <div class="album-echo"><div style="background: {{album.color}};"></div></div>
    <div class="album-art animate">
        <svg class="square" viewBox="0 0 100 100">
            <rect x="0" y="0" width="100" height="100" fill="none"></rect>
        </svg>
        <div style="background-image: url('{{album.art}}')"></div>
        <div style="background: {{album.color}};"></div>
    ...
    <div class="album-caption">
        <h1 class="animate" style="background: {{album.color}};" ng-bind-html="album.title"></h1>
        <h2 class="animate" style="background: {{album.color}};" ng-bind-html="album.genre"></h2>
    </div>
</a>