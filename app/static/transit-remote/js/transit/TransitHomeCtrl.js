...
function TransitHomeCtrl($scope, $timeout, University, DeviceService, Routes, InAppMapService, $ionicModal) {
	...
	$ionicModal.fromTemplateUrl(BASE + 'templates/transit/route.details.modal.html', options).then(function(modal) {
	    routeModal = modal;
	});
