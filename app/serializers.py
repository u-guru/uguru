...
university_fields['school_color_dark'] = fields.String(attribute='school_color_dark')
university_fields['school_color_light'] = fields.String(attribute='school_color_light')
...
relationship_fields['student_transactions'] = fields.List(fields.Nested(transaction_fields))
relationship_fields['guru_transactions'] = fields.List(fields.Nested(transaction_fields))
relationship_fields['guru_files'] = fields.List(fields.Nested(file_fields))
relationship_fields['student_files'] = fields.List(fields.Nested(file_fields))
relationship_fields['guru_calendar'] = fields.List(fields.Nested(calendar_fields))
relationship_fields['student_calendar'] = fields.List(fields.Nested(calendar_fields))
relationship_fields['student_positions'] = fields.List(fields.Nested(calendar_fields))
relationship_fields['guru_positions'] = fields.List(fields.Nested(calendar_fields))
...
guru_shop_fields['id'] = fields.Integer(attribute='id')
