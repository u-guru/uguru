...
//Become-uguru
var guruCourse = element(by.id('E2E-guruCourse'));
var guruMajor = element(by.id('E2E-guruMajor'));
var guruSkill = element(by.id('E2E-guruSkill'));
var guruPhoto = element(by.id('E2E-guruPhoto'));
