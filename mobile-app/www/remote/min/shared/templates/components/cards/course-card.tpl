<div class="perspective-container full-xy flex-center p15xy" types='default, link, overlay, checkbox, badge' default-type="badge">
	<div class="course-card" ng-if='activeType === "default"'
		...
		<div class="course-card-border" style="background: #003262;"
			...
			on-init="t-enter"
			on-enter="p:[tr:scaleX(1), tro:center center, t:all 250ms ease-out]"></div>
	</div>
	...
	<div class="course-card with-hover" ng-if='activeType === "overlay"'
		...
		<div class="course-card-inside"
			init-with="p-op"
			on-init="t-enter"
			on-enter="a:[bounceIn-subtle:set:(dur:1000ms#func:linear):in:delay-150]">
			<h2 style="color: #003262;">BIO 1A</h2>
			<h1 style="color: #003262;">Introduction to Biology</h1>
		</div>
	...
	<div class="course-card" ng-if='activeType === "checkbox"'
		...
		<span class="course-card-count"
			...
			on-init="t-enter"
			on-enter="a:[bounceIn-subtle:set:(dur:1000ms#func:linear):in:delay-250]">
			<span style="background: #003262;"></span>
