<div class="full-xy flex-center p15xy" types='academic-desktop, academic-mobile, baking-desktop, baking-mobile, photo-desktop, photo-mobile, tech-desktop, tech-mobile, household-desktop' default-type="household-desktop">
	...
	<div class="pf-tile-container" ng-if='activeType === "household-desktop"'
		...
		<div class="pf-tile bg-household">
			<div class="pf-tile-top" style="background-image: url('http://s.hswstatic.com/gif/quiz-cleaning-orig.jpg')"></div>
