<div class="full-xy flex-center p15xy">
	<div class="wallet-container"
		...
		on-init="t-enter"
		on-enter="a:[bounceInLeft-subtle:set:(dur:1000ms#func:linear):in]">
		...
		<svg class="wallet-exterior absolute top-0 left-0" viewBox="0 0 264 199">
			<g fill="none" fill-rule="evenodd" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"
				...
				on-init="t-enter"
				on-enter="p:[tr:rotateY(0deg):delay-150, t:all 500ms ease-out]">
		...
		<svg class="wallet-latch absolute top-0 left-0" viewBox="0 0 264 199">
			<g fill="none" fill-rule="evenodd" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"
				...
				on-init="t-enter"
				on-enter="p:[tr:rotateY(0deg) rotateX(0deg):delay-450, t:all 500ms ease-out]">
		...
		<div>
			<h1
				init-with="p-op"
				on-init="t-enter"
				on-enter="a:[fadeIn:set:(dur:800ms#func:cubic-bezier(.8#.1#1#.05)):in:delay-450]">My Wallet</h1>
			<button
				init-with="p-op"
				on-init="t-enter"
				on-enter="a:[bounceIn-subtle:set:(dur:1000ms#func:linear):in:delay-450]">Add&nbsp;Card</button>
		</div>
	</div>
</div>
