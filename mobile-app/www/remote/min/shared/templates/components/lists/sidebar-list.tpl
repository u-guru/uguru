		...
		<ul>
			<li class="flex-center-vertical-space-between p15xy height-96 bg-slate-75p"
				...
				<h3 class="txt-24 semibold"
					...
					when-email-click="p:[color:#ffffff, t:all 50ms]">Validate Email</h3>
				<div class="list-icon-white svg-48 svg-stroke-6"
					...
					when-email-click="p:[stroke:#ffffff, t:all 50ms]">
			...
			<li class="flex-center-vertical-space-between p15xy height-96 bg-slate-50p"
				...
				<h3 class="txt-24 semibold"
					...
					when-email-click-2="p:[color:#ffffff, t:all 50ms]">Validate Email</h3>
				<div class="svg-48 svg-stroke-6"
					...
					when-email-click-2="p:[stroke:#ffffff, t:all 50ms]">
					<svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    					<path d="M15,31.9968376 C15,27.5803062 18.579658,24 22.9957852,24 L77.0042148,24 C81.420165,24 85,27.5741706 85,31.9968376 L85,68.0031624 C85,72.4196938 81.420342,76 77.0042148,76 L22.9957852,76 C18.579835,76 15,72.4258294 15,68.0031624 L15,31.9968376 L15,31.9968376 Z M84.9111543,31.4941352 L49.9585003,55.0012225 L15.0058463,31.4941352 M42.8716789,50.2025451 L15.0946246,68.884039 L42.8716789,50.2025451 M57.2229457,50.2025451 L85,68.884039 L57.2229457,50.2025451" fill="none"  stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
					</svg>
				</div>
			...
			<li class="flex-center-vertical-space-between p15xy height-96 bg-slate-25p"
				...
				<h3 class="txt-24 semibold"
					...
					when-email-click-3="p:[color:#ffffff, t:all 50ms]">Validate Email</h3>
				<div class="svg-48 svg-stroke-6"
					init-with="p:[stroke:#ffffff]"
					...
					when-email-click-3="p:[stroke:#ffffff, t:all 150ms ease-in]">
					<svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    					<path d="M15,31.9968376 C15,27.5803062 18.579658,24 22.9957852,24 L77.0042148,24 C81.420165,24 85,27.5741706 85,31.9968376 L85,68.0031624 C85,72.4196938 81.420342,76 77.0042148,76 L22.9957852,76 C18.579835,76 15,72.4258294 15,68.0031624 L15,31.9968376 L15,31.9968376 Z M84.9111543,31.4941352 L49.9585003,55.0012225 L15.0058463,31.4941352 M42.8716789,50.2025451 L15.0946246,68.884039 L42.8716789,50.2025451 M57.2229457,50.2025451 L85,68.884039 L57.2229457,50.2025451" fill="none" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
					</svg>
				</div>
