<div class="full-xy flex-center" types='student, guru, no-padding, large-icons' default-type="large-icons">
	...
	<div class="attach-list guru" ng-if='activeType === "guru"'>
		<ul>
			...
			<li>
				<a>
					<span>
						<span style="background-image: url('https://38.media.tumblr.com/avatar_895d9e0c6ef1_128.png');"></span>
					</span>
					<span>image.jpg</span>
					<div>
						<div class="top"
