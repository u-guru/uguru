<div>
    ...
    <div class='bg-charcoal txt-white fixed bottom-0 left-0 full-x z-index-999' id='admin-anim-tools' ng-if='debug.options.showToolbar'>
        <div class="flex full-x bg-slate-50p">
            ...
            <ul class="relative flex-center-vertical-wrap p15-grid flex-stretch" style="width: calc(100% - 128px);">
                ...
                <li class='absolute top-0 right-0 p15x full-y flex-wrap-center' >
