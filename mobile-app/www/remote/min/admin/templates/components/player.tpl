<div id='transition-player'>
    <div class='ugrid flex-stretch full-x'>
        ...
        <span class='p10x p05y bg-charcoal m10x txt-2 weight-600' ng-hide='activeAttrIndex && activeAttrIndex !== $index' ng-repeat='(key, value) in props.attr track by $index' ng-if='props.attr' ng-click='activateAttr($index, key); ' ng-class='{"txt-charcoal bg-smoke":activeAttrIndex === $index}'>
