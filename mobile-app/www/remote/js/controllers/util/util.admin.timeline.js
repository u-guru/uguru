	...
	function($scope, $state, $stateParams, Restangular, User, $ionicSideMenuDelegate, LoadingService, $timeout, University, TimelineService, CTAService) {
		...
		var getProjectOneActionItems = function() {
			...
			resultDict.alpha = [
				...
				{'Page Linking':true},
				{'Fix (onEnter background gradient fill + banner_url)':true},
				{'MVP Scroll reveal spec + implement':true},
				{'Plan the week + admin calendar + add dates':false},
				{'Data: resolve AllLower(), Template the fuck, Categories, Tiny Name, Popular Courses, Map ALL departments so two versoins, Content, Privacy Terms': false},
