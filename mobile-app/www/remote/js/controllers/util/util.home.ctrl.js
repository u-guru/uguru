...
.controller('HomeController', [
	...
	function($scope, $state, $stateParams, Restangular, User, $ionicSideMenuDelegate,
		...
		$scope.page.animations.hiw = {
			...
			beforeScroll: null,
			firstViewed: {
				css_classes: ['bounceInDown', 'bounceInRight', 'bounceInLeft', 'bounceInLeft', 'bounceInRight', 'bounceInUp', 'animate'],
				selectors: ['.hiw-postit-li:nth-child(2)', '.hiw-postit-li:nth-child(6)', '.hiw-postit-li:nth-child(4)', '.hiw-postit-li:nth-child(1)', '.hiw-postit-li:nth-child(3)', '.hiw-postit-li:nth-child(5)', '.tape'],
				delays: [500, 600, 700, 800, 900, 1000, 1100],
			},
