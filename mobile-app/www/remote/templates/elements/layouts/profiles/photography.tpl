<div class="pf-container pf-photography">
    <aside class="pf-aside">
        <div class="pf-aside-bg" style="background-image: url('http://static.tumblr.com/351df1b52174deb762d181ec2c714721/mo4wohs/tqKn7b3uw/tumblr_static_1uf0xpk1ewasko88kg008ccsc.jpg');"></div>
        <div class="pf-aside-widget">
            ...
            <button class="bg-photography normal">Contact Guru</button>
        </div>
        ...
        <main class="pf-main">
            <div class="pf-profile pf-main-section active">
                ...
                <ul class="pf-items">
                    <li>
                        <div class="pf-tile bg-photography">
                            <div class="pf-tile-top" style="background-image: url('http://dab1nmslvvntp.cloudfront.net/wp-content/uploads/2014/06/1404092535image03.jpg');">
                            </div>
                    ...
                    <li>
                        <div class="pf-tile bg-photography">
                            <div class="pf-tile-top" style="background-image: url('https://usatsbi.files.wordpress.com/2015/09/university-of-virginia-mens-soccer-photo-e1443193134950.jpg');">
                            </div>
                            <div class="pf-tile-bottom">
                ...
                <ul class="pf-items">
                    ...
                    <li>
                        <div class="pf-cardlet highlight bg-photography">
                            <div class="pf-cardlet-front" style="background-image: url('http://24.media.tumblr.com/tumblr_ma03xxNmRs1qg22rso1_500.png');">
                            </div>
                            <div class="pf-cardlet-bottom">
                                <h1>Outdoor Scenes</h1>
                                <div>
                                    <h2>03/28/2016</h2>
                                </div>
                            </div>
            ...
            <div class="pf-portfolio pf-main-section">
                ...
                <ul class="pf-items">
                    ...
                    <li>
                        <div class="pf-tile bg-photography">
                            <div class="pf-tile-top" style="background-image: url('http://g-ecx.images-amazon.com/images/G/01/img15/pet-products/small-tiles/23695_pets_vertical_store_dogs_small_tile_8._CB312176604_.jpg');">
                            </div>
                            <div class="pf-tile-bottom">
                                <h1>Animals and Pets</h1>
                                <div class="pf-pricing">$10/hr</div>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="pf-tile bg-photography">
                            <div class="pf-tile-top" style="background-image: url('http://media.graytvinc.com/images/Graduation210.jpg');">
                            </div>
                            <div class="pf-tile-bottom">
                    ...
                    <li>
                        <div class="pf-tile bg-photography">
                            <div class="pf-tile-top" style="background-image: url('https://www.doielounge.com/wp-content/uploads/2015/03/Animal-Dance-Party.jpg');">
                            </div>
                            <div class="pf-tile-bottom">
