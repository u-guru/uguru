...
with open('university_of_oklahama_data.json') as datafile:
        ...
        for x in range(1,len(huge_arr)):
                ...
                if (x % 999 == 0):
                        add_students_to_mailing_list('University of Oklahoma',second_array)
                        response = add_students_to_mailing_list('University of Oklahoma',second_array)
                        print response.text
