...
with open('michigan_tech_data.json') as datafile:
        ...
        for x in range(1,len(huge_arr)):
                ...
                if (x % 999 == 0):
                        add_students_to_mailing_list('Michigan Technological University',second_array)
                        response = add_students_to_mailing_list('Michigan Technological University',second_array)
                        print response.text
