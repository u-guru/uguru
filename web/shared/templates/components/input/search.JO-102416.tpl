<div class="perspective-container full-xy flex-center p15xy">
    <fieldset class="search-bar"
        ...
        on-init="s:[search-bar-init:public] | a:[opacity:0:1:1500:easeOutQuint:0:1:f, translateX:500px:0px:250:easeInOutElastic:0:1:f]"
        ...
        <div>
            ...
            <input id="search-bar" placeholder="Filter" value=""
                u init-with="p-op"
                when-search-bar-clicked="p:[opacity:0:1:250:easeOutSine:250:1:f]"/>
        </div>
    </fieldset>
</div>
