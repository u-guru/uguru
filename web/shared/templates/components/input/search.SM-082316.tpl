    <!-- speed="2x"
    start-at="t:45%" -->
    <inspector-gadget show-log="false" ball-color="smoke" reverse-speed="10"  class="bottom-0 bg-azure"  auto-play="false" step-size="16" play-infinite="false"> </inspector-gadget>
