<div class="full-xy flex-center-wrap p15xy" reference="https://codepen.io/teamuguru/pen/0dd0f5b893950ead5db6bc302daf956f?editors=1100, http://codepen.io/teamuguru/pen/553314ac263ad7c0cd070bdf53969aa1?editors=1100, http://codepen.io/teamuguru/pen/e73453ab175045bd429577c423c2cb47?editors=1100"
	types='light, dark, large-light, large-dark, light-search, dark-search, large-light-search, large-dark-search' default-type="light">

	<div class="p30xy radius-2 bg-slate full-x" style="max-width:460px"	 ng-if='activeType === "light"'>
		<div class="input-border"
			u on-init="s:[input-border-enter:>children]"
			when-input-invalid="a:[translateY:0px:10px:100:linear:0:6:a]">
			<input class="input-border light" type="email" required placeholder=""
				u
				on-valid="s:[input-valid:>grandchildren]"
				on-invalid="s:[input-invalid:>grandchildren]"/>
			<label u init-with="p:[opacity:0]"
				...
				<svg class="input-icon email-icon" viewBox="0 0 100 100">
					<g fill="none" stroke-linecap="round" stroke-linejoin="round"
						u
						when-input-valid="s:[input-valid-stroke:self]"
						when-input-invalid="s:[input-invalid-stroke:self]"
						...
						<path d="M63.9709069,63.9709069 C60.39544,67.5463738 55.4559785,69.757846 50,69.757846 C39.088043,69.757846 30.242154,60.911957 30.242154,50 C30.242154,39.088043 39.088043,30.242154 50,30.242154 C55.4732289,30.242154 60.4266694,32.4676325 64.00478,36.063048 C66.4130625,38.4829778 68.1983075,41.5235021 69.0996581,44.9237641 C69.5290494,46.5436031 69.757846,48.2450824 69.757846,50 C69.757846,53.9347216 69.2262746,59.3417259 73.4417381,62.5812267 C77.4282262,65.6447644 82.9286479,65.1002753 85.6110917,62.5812267 C88.2935356,60.0621781 89.2868458,57.3718152 89.8060548,53.9347216 C91.7706634,31.4800197 75.4920198,12.0798877 53.4860197,10.1546122 C31.4800197,8.22933664 12.0798877,24.5079802 10.1546122,46.5139803 C8.22933664,68.5199803 24.5079802,87.9201123 46.5139803,89.8453878 C57.5169803,90.8080256 67.8685133,87.2196836 75.7099557,80.6399321" class="email"
							u init-with="p:[sdo:365.6]"
							when-input-border-enter="a:[stroke-dashoffset:365.6:0:150:easeOutExpo:0:1:f]:delay-100"
				...
				<span class="label" style="transform-origin:bottom center" u
					u init-with="p:[transform:rotateX(90deg)]"
					on-init="a:[rotateX:90deg:0deg:1000:easeOutExpo:0:1:f]">Border light</span>
				<span class="input"
					u init-with="p:[op:0]">Lorem&nbsp;ipsum&nbsp;dolor&nbsp;sit&nbsp;amet|</span>
				<div class="underline" u
					init-with="p:[transform:scaleX(0), tro:left center]"
					when-input-border-enter="a:[scaleX:0:1:500:easeOutExpo:250:1:f]">
				...
				<div class="borders">
					<div>
						...
						<div u
							when-input-valid="p:[bg:#43cb9d, tr:scale(1), op:1]"
							when-input-invalid="p:[bg:#d3242c, tr:scale(1), op:1]"></div>
					</div>
					<div>
						<div u
							when-input-valid="p:[bg:#43cb9d]:delay-500"
	...
	<div class="p30xy radius-2 bg-white full-x" style="max-width:460px" ng-if='activeType === "dark"'>
		<div class="input-border"
			u
			on-init="s:[input-border-enter:depth(>3)]"
			when-input-invalid="a:[translateY:0px:10px:100:linear:0:6:a]">
			<input class="input-border dark" type="email" required placeholder=""
				u
				on-valid="s:[input-valid:>children]"
				on-invalid="s:[input-invalid:>children]"/>
			<label u init-with="p:[opacity:0]"
				on-init="a:[opacity:0.0:1.0:1000:linear:0:1:f]">
				<svg class="input-icon email-icon" viewBox="0 0 100 100">
					<g fill="none" stroke-linecap="round" stroke-linejoin="round"
				...
				<span class="label"
					u init-with="p:[op:0, tr:rotateX(90deg), tro:bottom center]"
					when-input-border-enter="a:[opacity:0:1:250:easeOutExpo:0:1:f, rotateX:90deg:0deg:250:easeOutExpo:0:1:f]:delay-200">Border dark</span>
				<span class="input"
					u init-with="p:[op:0]">Lorem&nbsp;ipsum&nbsp;dolor&nbsp;sit&nbsp;amet|</span>
				<div class="underline">
					<div u init-with="p:[tr:scaleX(0)]"
	...
	<div class="p30xy radius-2 bg-slate full-x" style="max-width:860px" ng-if='activeType === "large-light"'>
		<div class="input-border large"
			u
			on-init="s:[input-border-enter:depth(>2)]"
			when-input-invalid="a:[translateY:0px:10px:100:linear:0:6:a]">
			<input class="input-border light" type="email" required placeholder=""
				u
				on-valid="s:[input-valid:>children]"
			...
			<label>
				...
				<span class="label"
					u init-with="p:[op:0, tr:rotateX(90deg), tro:bottom center]"
					when-input-border-enter="a:[opacity:0:1:250:easeOutExpo:0:1:f, rotateX:90deg:0deg:250:easeOutExpo:0:1:f]:delay-200">Large border light</span>
				<span class="input"
					u init-with="p:[op:0]">Lorem&nbsp;ipsum&nbsp;dolor&nbsp;sit&nbsp;amet|</span>
				<div class="underline">
					<div u init-with="p:[tr:scaleX(0)]"
	...
	<div class="p30xy radius-2 bg-white full-x" style="max-width:860px" ng-if='activeType === "large-dark"'>
		<div class="input-border large"
			u
			on-init="s:[input-border-enter:depth(>2)]"
			when-input-invalid="a:[translateY:0px:10px:100:linear:0:6:a]">
			...
			<label>
				...
				<div class="underline">
					<div init-with="p:[tr:scaleX(0)]"
						u when-input-border-enter="a:[scaleX:0:1:250:easeOutExpo:0:1:f]"></div>
					<div></div>
				</div>
				<div class="borders">
					<div>
	...
	<div class="p30xy radius-2 bg-slate full-x" style="max-width:460px" error ng-if='activeType === "light-search"'>
		<div class="input-border"
			u
			on-init="s:[input-border-enter:depth(>1)]">
				...
				<svg class="input-icon" viewBox="0 0 100 100">
					<g fill="none" stroke-linecap="round" stroke-linejoin="round">
						<path d="M62.994485,62.994485 L85.6624699,85.6624699"
							u init-with="p:[sda:32.1, sdo:32.1]"
							when-input-border-enter="a:[stroke-dashoffset:32.1:0:75:easeOutExpo:150:1:f"></path>
				        <circle cx="42.5" cy="42.5" r="28.5"
							u init-with="p:[sda:179.1, sdo:179.1]"
							when-input-border-enter="a:[stroke-dashoffset:179.1:0:250:easeInExpo:100:1:f]"></circle>
					</g>
				</svg>
				<span class="label"
					u init-with="p:[op:0, tr:rotateX(90deg), tro:bottom center]"
					when-input-border-enter="a:[opacity:0:1:250:easeOutExpo:0:1:f, rotateX:90deg:0deg:250:easeOutExpo:0:1:f]:delay-200">Border light search</span>
				<span class="input"
					u init-with="p:[op:0]">Lorem&nbsp;ipsum&nbsp;dolor&nbsp;sit&nbsp;amet|</span>
				<div class="underline">
					<div u init-with="p:[tr:scaleX(0)]"
	...
	<div class="p30xy radius-2 bg-white full-x" style="max-width:460px" ng-if='activeType === "dark-search"'>
		<div class="input-border"
			u
			on-init="s:[input-border-enter:>children]"
			when-input-invalid="a:[translateY:0px:10px:100:linear:0:6:a]">
			...
			<label>
				...
				<span class="label"
					u init-with="p:[op:0, tr:rotateX(90deg), tro:bottom center]"
					when-input-border-enter="a:[opacity:0:1:250:easeOutExpo:0:1:f, rotateX:90deg:0deg:250:easeOutExpo:0:1:f]:delay-200">Border dark search</span>
				<span class="input"
					u init-with="p:[op:0]">Lorem&nbsp;ipsum&nbsp;dolor&nbsp;sit&nbsp;amet|</span>
				<div class="underline">
					<div u init-with="p:[tr:scaleX(0)]"
	...
	<div class="p30xy radius-2 bg-slate full-x" style="max-width:860px" ng-if='activeType === "large-light-search"'>
		<div class="input-border large"
			u
			on-init="s:[input-border-enter:>children]">
			<input class="input-border light" type="search" required placeholder=""
				u
				on-focus="s:[input-focus:>children]"
				on-blur="s:[input-blur:>children]"/>
			<label>
				<svg class="input-icon" viewBox="0 0 100 100">
					<g fill="none" stroke-linecap="round" stroke-linejoin="round">
						<path d="M62.994485,62.994485 L85.6624699,85.6624699"
				...
				<span class="label"
					u init-with="p:[op:0, tr:rotateX(90deg), tro:bottom center]"
					when-input-border-enter="a:[opacity:0:1:250:easeOutExpo:0:1:f, rotateX:90deg:0deg:250:easeOutExpo:0:1:f]:delay-200">Border light large search</span>
				<span class="input"
					u init-with="p:[op:0]">Lorem&nbsp;ipsum&nbsp;dolor&nbsp;sit&nbsp;amet|</span>
				<div class="underline">
					<div u init-with="p:[tr:scaleX(0)]"
	...
	<div class="p30xy radius-2 bg-white full-x" style="max-width:860px" ng-if='activeType === "large-dark-search"'>
		<div class="input-border large"
			u
			on-init="s:[input-border-enter:>children]">
			<input class="input-border dark" type="search" required placeholder=""/>
			<label>
				...
				<span class="label"
					u init-with="p:[op:0, tr:rotateX(90deg), tro:bottom center]"
					when-input-border-enter="a:[opacity:0:1:250:easeOutExpo:0:1:f, rotateX:90deg:0deg:250:easeOutExpo:0:1:f]:delay-200">Border dark large search</span>
				<span class="input"
					u init-with="p:[op:0]">Lorem&nbsp;ipsum&nbsp;dolor&nbsp;sit&nbsp;amet|</span>
				<div class="underline">
					<div u init-with="p:[tr:scaleX(0)]"
