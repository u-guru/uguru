<div class="perspective-container full-xy flex-center bg-slate">
	<div class="impact-meter"
		...
		on-init="a:[opacity:0:1:250:easeOutSine:0:1:f]">
		<svg width="99px" height="51px" viewBox="0 0 99 51">
			<g fill="none" fill-rule="evenodd">
				...
				<path d="M86.5,49.5 C86.5,29.0654643 70.1583934,12.5 50,12.5 C29.8416066,12.5 13.5,29.0654643 13.5,49.5"
					...
					u init-with="p:[stroke:#F6C64E, transform-origin:center center, transform:rotateY(180deg), stroke-dasharray:115.47, stroke-dashoffset:38.49]"
					on-init="a:[stroke:#F6C64E:#43cb9d:450:easeOutSine:250:1:f, stroke-dashoffset:38.49:0:450:easeOutSine:250:1:f]"></path>
					<!-- $gold: #F6C64E;
					$moxie: #43cb9d;

					white to gold
					init-with="p:[stroke:#ffffff, tro:center center, tr:rotateY(180deg), sda:115.47, sdo:115.47]"
					on-init="p:[stroke:#F6C64E, sdo:38.49, t:all 450ms ease-out]"

					zero to white
					init-with="p:[op:0, stroke:#ffffff, tro:center center, tr:rotateY(180deg), sda:115.47, sdo:115.47]"
					on-init="p:[op:1, stroke:#ffffff, sdo:77.05, t:all 450ms ease-out]" -->
