						...
						<div class="pf-tile-container mobile"
							...
							<div class="pf-tile bg-academic"
								...
								<div class="pf-tile-border"
									...
									when-academic-tile-exit="p:[transform:rotateX(0deg) rotateY(0deg):rotateX(-30deg) rotateY(30deg):1000:easeOutCubic easeOutCubic easeOutCubic, opacity:1:0:1000:easeOutSine]:delay-1500">
									<div class="top"></div>
									<div class="right"></div>
									<div class="bot"></div>
									<div class="left"></div>
