...
<div class="pf-container pf-academic"
	on-init="s:[pf-aside-init:public, pf-rest-init:public:delay-1000]">
	<aside class="pf-aside perspective-container"
		init-with="p:[op:0, tro:center top]"
		when-pf-aside-init="s:[pf-aside-content-init:public:delay-1000] | a:[pf-bounceDown:set:(dur:2000ms#func:linear):in]"
		when-pf-aside-content-init="s:[pf-aside-bg-init:public:delay-1500, pf-widget-init:public, pf-cta-init:public:delay-500]"
		...
		<div class="pf-aside-widget">
			...
			<span class="user-icon" style="background-image: url('http://en.gravatar.com/userimage/5102999/c223080350b67306f21725b6cf57920a.jpg?size=256');"
				init-with="p-op"
				when-pf-widget-init="p:[tro:center center] | a:[icon-enter-rotate:set:(dur:1000ms#func:ease-out):in]"></span>
			<div>
		...
		<div class="pf-aside-mobile">
			<span class="pf-icon user-icon" style="background-image: url('http://en.gravatar.com/userimage/5102999/c223080350b67306f21725b6cf57920a.jpg?size=256');"
				init-with="p:[tro:center center, transform:scale(0)]"
				when-pf-widget-init="p:[transform:scale(0) rotate(-15deg):scale(1) rotate(0deg):500:easeOutBack easeOutQuad]"></span>
			<h1 class="pf-name verified">
				<span init-with="p:[op:0, tr:translateY(-10px)]" when-pf-widget-init="p:[opacity:0:1:250:easeInSine, transform:translateY(-10px):translateY(0px):450:easeInOutBack]:delay-100">Gabrielle Wee</span>
				<span init-with="p:[op:0, tr:translateY(-10px)]" when-pf-widget-init="p:[opacity:0:1:250:easeInSine, transform:translateY(-10px):translateY(0px):450:easeInOutBack]:delay-100">
					<svg preserveAspectRatio="xMidYMax meet" width="100px" height="100px" viewBox="0 0 100 100">
						<path d="M95.588027,38.378 C97.014027,35.692 97.112027,32.487 95.858027,29.716 C94.603027,26.944 92.136027,24.922 89.189027,24.248 C85.056027,23.304 82.013027,19.762 81.674027,15.504 C81.433027,12.467 79.797027,9.716 77.255027,8.069 C74.712027,6.422 71.554027,6.065 68.714027,7.105 C64.730027,8.563 60.272027,7.242 57.704027,3.845 C55.871027,1.423 53.021027,0 50.000027,0 C46.978027,0 44.129027,1.423 42.296027,3.846 C39.728027,7.242 35.268027,8.563 31.287027,7.105 C28.446027,6.065 25.286027,6.422 22.745027,8.069 C20.202027,9.716 18.567027,12.466 18.325027,15.504 C17.986027,19.762 14.942027,23.303 10.811027,24.248 C7.86302696,24.922 5.39602696,26.944 4.14102696,29.717 C2.88502696,32.488 2.98502696,35.692 4.41102696,38.379 C6.40902696,42.146 5.74602696,46.784 2.77702696,49.831 C0.659026961,52.005 -0.331973037,55.05 0.0990269614,58.067 C0.529026961,61.083 2.33002696,63.723 4.97002696,65.208 C8.67002696,67.288 10.601027,71.55 9.737027,75.731 C9.121027,78.713 9.921027,81.815 11.900027,84.12 C13.879027,86.423 16.811027,87.663 19.828027,87.472 C24.057027,87.204 27.966027,89.738 29.480027,93.728 C30.562027,96.574 32.898027,98.746 35.798027,99.605 C38.697027,100.464 41.829027,99.908 44.264027,98.103 C47.678027,95.574 52.326027,95.574 55.738027,98.103 C58.175027,99.908 61.304027,100.464 64.205027,99.605 C67.104027,98.746 69.441027,96.574 70.522027,93.728 C72.037027,89.738 75.947027,87.205 80.175027,87.472 C83.191027,87.663 86.122027,86.423 88.101027,84.12 C90.081027,81.815 90.880027,78.714 90.265027,75.731 C89.401027,71.549 91.330027,67.288 95.031027,65.208 C97.672027,63.724 99.474027,61.083 99.902027,58.067 C100.331027,55.049 99.341027,52.004 97.221027,49.83 C94.253027,46.784 93.591027,42.145 95.588027,38.378 Z" fill="#000000"></path>
						<path d="M66.75725,32.75725 L41.35225,58.16125 L33.24225,50.05125 C30.89925,47.70825 27.10025,47.70825 24.75725,50.05125 C22.41425,52.39425 22.41425,56.19325 24.75725,58.53625 L37.11025,70.88925 C39.45325,73.23225 43.25225,73.23225 45.59525,70.88925 L75.24225,41.24225 C77.58525,38.89925 77.58525,35.10025 75.24225,32.75725 C72.89925,30.41425 69.10025,30.41425 66.75725,32.75725 Z" fill="#FFFFFF"></path>
					</svg>
			...
			<h2 class="pf-school-name" init-with="p:[op:0, tr:translateY(-10px)]" when-pf-widget-init="p:[opacity:0:1:250:easeInSine, transform:translateY(-10px):translateY(0px):450:easeInOutBack]:delay-200">Ex'pression College for Digital Arts</h2>
			<ul class="pf-rating rating-stars" data-rating="4" data-half="true">
				<li	init-with="p:[tr:rotate(-45deg) scale(0), tro:center center]"
					when-pf-widget-init="p:[transform:rotate(-45deg) scale(0):rotate(0deg) scale(1):500:easeOutExpo easeOutBack]:delay-500">
					<svg viewBox="0 0 100 100">
						<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
						<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
					</svg>
				...
				<li	init-with="p:[tr:rotate(-45deg) scale(0), tro:center center]"
					when-pf-widget-init="p:[transform:rotate(-45deg) scale(0):rotate(0deg) scale(1):500:easeOutExpo easeOutBack]:delay-600">
					<svg viewBox="0 0 100 100">
						<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
						<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
					</svg>
				...
				<li	init-with="p:[tr:rotate(-45deg) scale(0), tro:center center]"
					when-pf-widget-init="p:[transform:rotate(-45deg) scale(0):rotate(0deg) scale(1):500:easeOutExpo easeOutBack]:delay-700">
					<svg viewBox="0 0 100 100">
						<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
						<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
					</svg>
				...
				<li	init-with="p:[tr:rotate(-45deg) scale(0), tro:center center]"
					when-pf-widget-init="p:[transform:rotate(-45deg) scale(0):rotate(0deg) scale(1):500:easeOutExpo easeOutBack]:delay-800">
					<svg viewBox="0 0 100 100">
						<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
						<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
					</svg>
				...
				<li	init-with="p:[tr:rotate(-45deg) scale(0), tro:center center]"
					when-pf-widget-init="p:[transform:rotate(-45deg) scale(0):rotate(0deg) scale(1):500:easeOutExpo easeOutBack]:delay-900">
					<svg viewBox="0 0 100 100">
						<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
						<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
					</svg>
				...
				<ul class="pf-items">
					<li>
						<div class="pf-tile-container mobile"
							...
							<div class="pf-tile bg-academic"
								...
								when-academic-tile-init-1="p:[background:rgba(99#112#116#0):rgba(99#112#116#1):500:easeOutSine]:delay-650"
								...
								<div class="pf-tile-border"
									...
									when-academic-tile-init-1="p:[opacity:0:0.5:500:easeOutSine, transform:rotateX(-30deg) rotateY(30deg):rotateX(0deg) rotateY(0deg):1000:easeOutCubic]"
								...
								<div class="pf-tile-top"
									...
									<div class="pf-pricing"
										init-with="p-op"
										when-academic-tile-init-1="p:[opacity:0:1:500:easeOutSine]:delay-900">$10/hr</div>
									<div class="pf-tile-icon"
										init-with="p:[tr:translateY(-100px), op:0]"
										when-academic-tile-init-1="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-750"
									...
									<h1 init-with="p:[op:0, tr:translateY(-100px)]"
										when-academic-tile-init-1="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-500"
										when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine]:delay-750">Chem 133</h1>
									<h2 init-with="p:[op:0, tr:translateY(-100px)]"
										when-academic-tile-init-1="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-500"
					...
					<li>
						<div class="pf-tile-container mobile"
							...
							<div class="pf-tile bg-academic"
								init-with="p:[bg:rgba(99#112#116#0)]"
								when-academic-tile-init-2="p:[background:rgba(99#112#116#0):rgba(99#112#116#1):500:easeOutSine]:delay-650"
								when-academic-tile-exit="p:[opacity:1:0:1500:easeOutQuad]:delay-1000">
								<div class="pf-tile-border"
									init-with="p:[tro:left top, tr:rotateX(-30deg) rotateY(30deg), op:0]"
									when-academic-tile-init-2="p:[opacity:0:0.5:500:easeOutSine, transform:rotateX(-30deg) rotateY(30deg):rotateX(0deg) rotateY(0deg):1000:easeOutCubic]"
									when-academic-tile-exit="p:[transform:rotateX(0deg) rotateY(0deg):rotateX(-30deg) rotateY(30deg):1000:easeOutCubic, opacity:1:0:1000:easeOutSine]:delay-1500">
									<div class="top"></div>
									<div class="right"></div>
									<div class="bot"></div>
								...
								<div class="pf-tile-top"
									...
									<div class="pf-pricing"
										init-with="p-op"
										when-academic-tile-init-2="p:[opacity:0:1:500:easeOutSine]:delay-900">$10/hr</div>
									<div class="pf-tile-icon"
										init-with="p:[tr:translateY(-100px), op:0]"
										when-academic-tile-init-2="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-750"
										when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine]:delay-750">
										<svg viewBox="0 0 100 100">
											<g>
												<path d="M61.993,18 L25.006,18 C23.334,18 22,19.344 22,21.001 L22,30 L25.002,30 C26.658,30 28,31.346 28,33 C28,34.657 26.658,36 25.002,36 L22,36 L22,47 L25.002,47 C26.658,47 28,48.346 28,50 C28,51.657 26.658,53 25.002,53 L22,53 L22,64 L25.002,64 C26.658,64 28,65.346 28,67 C28,68.657 26.658,70 25.002,70 L22,70 L22,78.999 C22,80.663 23.346,82 25.006,82 L61.993,82 C63.666,82 65,80.656 65,78.999 L65,21.001 C65,19.337 63.654,18 61.993,18 L61.993,18 Z"></path>
									...
									<h1 init-with="p:[op:0, tr:translateY(-100px)]"
										when-academic-tile-init-2="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-500"
										when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine]:delay-750">Chem 133</h1>
									<h2 init-with="p:[op:0, tr:translateY(-100px)]"
										when-academic-tile-init-2="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-500"
										when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine]:delay-750">Organic Chemistry</h2>
				...
				<ul class="pf-items">
					<li>
						<div class="pf-tile-container mobile"
							...
							when-academic-cardlet-init-1="p:[transform:rotateX(-30deg) rotateY(30deg):rotateX(0deg) rotateY(0deg):1000:easeOutCubic easeOutExpo, opacity:0:1:500:easeOutSine]"
					...
					<li>
						<div class="pf-tile-container mobile"
							...
							when-academic-cardlet-init-2="p:[transform:rotateX(-30deg) rotateY(30deg):rotateX(0deg) rotateY(0deg):1000:easeOutCubic easeOutExpo, opacity:0:1:500:easeOutSine]"
							when-academic-cardlet-exit="p:[transform:rotateX(0deg) rotateY(0deg):rotateX(-30deg) rotateY(30deg):1000:easeOutSine easeOutSine, opacity:1:0:1500:easeOutSine]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-cardlet highlight bg-academic">
								<div class="pf-cardlet-front-container">
			...
			<div class="pf-portfolio pf-main-section" ng-class="{'active': guru.section_index === 1}">
				...
				<ul class="pf-items">
					<li>
						<div class="pf-tile-container mobile"
							init-default
							when-pf-sv-init="s:[academic-tile-init-1:public]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-tile bg-academic"
								init-with="p:[bg:rgba(99#112#116#0)]"
								when-academic-tile-init-1="p:[background:rgba(99#112#116#0):rgba(99#112#116#1):500:easeOutSine]:delay-650"
					...
					<li>
						<div class="pf-tile-container mobile"
							init-default
							when-pf-sv-init="s:[academic-tile-init-2:public:delay-500]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-tile bg-academic"
								init-with="p:[bg:rgba(99#112#116#0)]"
								when-academic-tile-init-2="p:[background:rgba(99#112#116#0):rgba(99#112#116#1):500:easeOutSine]:delay-650"
					...
					<li>
						<div class="pf-tile-container mobile"
							init-default
							when-pf-sv-init="s:[academic-tile-init-3:public:delay-1000]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-tile bg-academic"
								init-with="p:[bg:rgba(99#112#116#0)]"
								when-academic-tile-init-3="p:[background:rgba(99#112#116#0):rgba(99#112#116#1):500:easeOutSine]:delay-650"
								when-academic-tile-exit="p:[opacity:1:0:1500:easeOutQuad]:delay-1000">
								<div class="pf-tile-border"
									init-with="p:[tro:left top, tr:rotateX(-30deg) rotateY(30deg), op:0]"
									when-academic-tile-init-3="p:[opacity:0:0.5:500:easeOutSine, transform:rotateX(-30deg) rotateY(30deg):rotateX(0deg) rotateY(0deg):1000:easeOutCubic]"
									when-academic-tile-exit="p:[transform:rotateX(0deg) rotateY(0deg):rotateX(-30deg) rotateY(30deg):1000:easeOutCubic, opacity:1:0:1000:easeOutSine]:delay-1500">
									<div class="top"></div>
									<div class="right"></div>
									<div class="bot"></div>
								...
								<div class="pf-tile-top"
									...
									<div class="pf-pricing"
										init-with="p-op"
										when-academic-tile-init-3="p:[opacity:0:1:500:easeOutSine]:delay-900">$10/hr</div>
									<div class="pf-tile-icon"
										init-with="p:[tr:translateY(-100px), op:0]"
										when-academic-tile-init-3="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-750"
										when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine]:delay-750">
										<svg viewBox="0 0 100 100">
											<g>
												<path d="M61.993,18 L25.006,18 C23.334,18 22,19.344 22,21.001 L22,30 L25.002,30 C26.658,30 28,31.346 28,33 C28,34.657 26.658,36 25.002,36 L22,36 L22,47 L25.002,47 C26.658,47 28,48.346 28,50 C28,51.657 26.658,53 25.002,53 L22,53 L22,64 L25.002,64 C26.658,64 28,65.346 28,67 C28,68.657 26.658,70 25.002,70 L22,70 L22,78.999 C22,80.663 23.346,82 25.006,82 L61.993,82 C63.666,82 65,80.656 65,78.999 L65,21.001 C65,19.337 63.654,18 61.993,18 L61.993,18 Z"></path>
									...
									<h1 init-with="p:[op:0, tr:translateY(-100px)]"
										when-academic-tile-init-3="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-500"
										when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine]:delay-750">Chem 133</h1>
									<h2 init-with="p:[op:0, tr:translateY(-100px)]"
										when-academic-tile-init-3="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-500"
										when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine]:delay-750">Organic Chemistry</h2>
					...
					<li>
						<div class="pf-tile-container mobile"
							init-default
							when-pf-sv-init="s:[academic-tile-init-4:public:delay-1500]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-tile bg-academic"
								init-with="p:[bg:rgba(99#112#116#0)]"
								when-academic-tile-init-4="p:[background:rgba(99#112#116#0):rgba(99#112#116#1):500:easeOutSine]:delay-650"
								when-academic-tile-exit="p:[opacity:1:0:1500:easeOutQuad]:delay-1000">
								<div class="pf-tile-border"
									init-with="p:[tro:left top, tr:rotateX(-30deg) rotateY(30deg), op:0]"
									when-academic-tile-init-4="p:[opacity:0:0.5:500:easeOutSine, transform:rotateX(-30deg) rotateY(30deg):rotateX(0deg) rotateY(0deg):1000:easeOutCubic]"
									when-academic-tile-exit="p:[transform:rotateX(0deg) rotateY(0deg):rotateX(-30deg) rotateY(30deg):1000:easeOutCubic, opacity:1:0:1000:easeOutSine]:delay-1500">
									<div class="top"></div>
									<div class="right"></div>
									<div class="bot"></div>
								...
								<div class="pf-tile-top"
									...
									<div class="pf-pricing"
										init-with="p-op"
										when-academic-tile-init-4="p:[opacity:0:1:500:easeOutSine]:delay-900">$10/hr</div>
									<div class="pf-tile-icon"
										init-with="p:[tr:translateY(-100px), op:0]"
										when-academic-tile-init-4="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-750"
										when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine]:delay-750">
										<svg viewBox="0 0 100 100">
											<g>
												<path d="M61.993,18 L25.006,18 C23.334,18 22,19.344 22,21.001 L22,30 L25.002,30 C26.658,30 28,31.346 28,33 C28,34.657 26.658,36 25.002,36 L22,36 L22,47 L25.002,47 C26.658,47 28,48.346 28,50 C28,51.657 26.658,53 25.002,53 L22,53 L22,64 L25.002,64 C26.658,64 28,65.346 28,67 C28,68.657 26.658,70 25.002,70 L22,70 L22,78.999 C22,80.663 23.346,82 25.006,82 L61.993,82 C63.666,82 65,80.656 65,78.999 L65,21.001 C65,19.337 63.654,18 61.993,18 L61.993,18 Z"></path>
									...
									<h1 init-with="p:[op:0, tr:translateY(-100px)]"
										when-academic-tile-init-4="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-500"
										when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine]:delay-750">Chem 133</h1>
									<h2 init-with="p:[op:0, tr:translateY(-100px)]"
										when-academic-tile-init-4="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-500"
										when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine]:delay-750">Organic Chemistry</h2>
					...
					<li>
						<div class="pf-tile-container mobile"
							init-default
							when-pf-sv-init="s:[academic-tile-init-5:public:delay-2000]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-tile bg-academic"
								init-with="p:[bg:rgba(99#112#116#0)]"
								when-academic-tile-init-5="p:[background:rgba(99#112#116#0):rgba(99#112#116#1):500:easeOutSine]:delay-650"
								when-academic-tile-exit="p:[opacity:1:0:1500:easeOutQuad]:delay-1000">
								<div class="pf-tile-border"
									init-with="p:[tro:left top, tr:rotateX(-30deg) rotateY(30deg), op:0]"
									when-academic-tile-init-5="p:[opacity:0:0.5:500:easeOutSine, transform:rotateX(-30deg) rotateY(30deg):rotateX(0deg) rotateY(0deg):1000:easeOutCubic]"
									when-academic-tile-exit="p:[transform:rotateX(0deg) rotateY(0deg):rotateX(-30deg) rotateY(30deg):1000:easeOutCubic, opacity:1:0:1000:easeOutSine]:delay-1500">
									<div class="top"></div>
									<div class="right"></div>
									<div class="bot"></div>
								...
								<div class="pf-tile-top"
									...
									<div class="pf-pricing"
										init-with="p-op"
										when-academic-tile-init-5="p:[opacity:0:1:500:easeOutSine]:delay-900">$10/hr</div>
									<div class="pf-tile-icon"
										init-with="p:[tr:translateY(-100px), op:0]"
										when-academic-tile-init-5="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-750"
										when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine]:delay-750">
										<svg viewBox="0 0 100 100">
											<g>
												<path d="M61.993,18 L25.006,18 C23.334,18 22,19.344 22,21.001 L22,30 L25.002,30 C26.658,30 28,31.346 28,33 C28,34.657 26.658,36 25.002,36 L22,36 L22,47 L25.002,47 C26.658,47 28,48.346 28,50 C28,51.657 26.658,53 25.002,53 L22,53 L22,64 L25.002,64 C26.658,64 28,65.346 28,67 C28,68.657 26.658,70 25.002,70 L22,70 L22,78.999 C22,80.663 23.346,82 25.006,82 L61.993,82 C63.666,82 65,80.656 65,78.999 L65,21.001 C65,19.337 63.654,18 61.993,18 L61.993,18 Z"></path>
									...
									<h1 init-with="p:[op:0, tr:translateY(-100px)]"
										when-academic-tile-init-5="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-500"
										when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine]:delay-750">Chem 133</h1>
									<h2 init-with="p:[op:0, tr:translateY(-100px)]"
										when-academic-tile-init-5="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-500"
										when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine]:delay-750">Organic Chemistry</h2>
					...
					<li>
						<div class="pf-tile-container mobile"
							init-default
							when-pf-sv-init="s:[academic-tile-init-6:public:delay-2500]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-tile bg-academic"
								init-with="p:[bg:rgba(99#112#116#0)]"
								when-academic-tile-init-6="p:[background:rgba(99#112#116#0):rgba(99#112#116#1):500:easeOutSine]:delay-650"
								when-academic-tile-exit="p:[opacity:1:0:1500:easeOutQuad]:delay-1000">
								<div class="pf-tile-border"
									init-with="p:[tro:left top, tr:rotateX(-30deg) rotateY(30deg), op:0]"
									when-academic-tile-init-6="p:[opacity:0:0.5:500:easeOutSine, transform:rotateX(-30deg) rotateY(30deg):rotateX(0deg) rotateY(0deg):1000:easeOutCubic]"
									when-academic-tile-exit="p:[transform:rotateX(0deg) rotateY(0deg):rotateX(-30deg) rotateY(30deg):1000:easeOutCubic, opacity:1:0:1000:easeOutSine]:delay-1500">
									<div class="top"></div>
									<div class="right"></div>
									<div class="bot"></div>
								...
								<div class="pf-tile-top"
									...
									<div class="pf-pricing"
										init-with="p-op"
										when-academic-tile-init-6="p:[opacity:0:1:500:easeOutSine]:delay-900">$10/hr</div>
									<div class="pf-tile-icon"
										init-with="p:[tr:translateY(-100px), op:0]"
										when-academic-tile-init-6="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-750"
										when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine]:delay-750">
										<svg viewBox="0 0 100 100">
											<g>
												<path d="M61.993,18 L25.006,18 C23.334,18 22,19.344 22,21.001 L22,30 L25.002,30 C26.658,30 28,31.346 28,33 C28,34.657 26.658,36 25.002,36 L22,36 L22,47 L25.002,47 C26.658,47 28,48.346 28,50 C28,51.657 26.658,53 25.002,53 L22,53 L22,64 L25.002,64 C26.658,64 28,65.346 28,67 C28,68.657 26.658,70 25.002,70 L22,70 L22,78.999 C22,80.663 23.346,82 25.006,82 L61.993,82 C63.666,82 65,80.656 65,78.999 L65,21.001 C65,19.337 63.654,18 61.993,18 L61.993,18 Z"></path>
									...
									<h1 init-with="p:[op:0, tr:translateY(-100px)]"
										when-academic-tile-init-6="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-500"
										when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine]:delay-750">Chem 133</h1>
									<h2 init-with="p:[op:0, tr:translateY(-100px)]"
										when-academic-tile-init-6="p:[opacity:0:1:750:easeOutSine, transform:translateY(-100px):translateY(0px):750:easeOutSine]:delay-500"
										when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine]:delay-750">Organic Chemistry</h2>
			...
			<div class="pf-about pf-main-section" ng-class="{'active': guru.section_index === 2}">
				...
				<div class="pf-about-section"
					...
					<div>
						...
						<h2 init-with="p:[op:0, transform:translateY(10px)]"
						...
						<ul>
							<li class="pf-ab-exp-anim">
								<div>
									...
									<div init-with="p:[tro:center center, transform:scale(0)]"
				...
				<div class="pf-about-section overflow-hidden"
					init-with="p:[op:0, transform:translateY(-15px):translateY(0px)]"
					when-shop-sect-init="p:[opacity:0:1:450:easeOutExpo, transform:translateY(-15px):translateY(0px):1000:easeOutQuad]">
					<header><h2>My other guru shops</h2></header>
					<div>
						<ul class="pf-about-shops">
							<li class="pf-ab-shop-anim">
								<a class="pf-tech" init-with="p:[transform:scale(0), tro: center center]"
									when-shop-sect-init="p:[transform:scale(0):scale(1):450:easeInQuad]">
							...
							<li class="pf-ab-shop-anim">
								<a class="pf-baking" init-with="p:[transform:scale(0), tro: center center]"
									when-shop-sect-init="p:[transform:scale(0):scale(1):450:easeInQuad]:delay-100">
									<svg viewBox="0 0 100 100" init-with="p:[tro:center center, tr:scale(0)]"
							...
							<li class="pf-ab-shop-anim">
								<a class="pf-photography" init-with="p:[transform:scale(0), tro: center center]"
									when-shop-sect-init="p:[transform:scale(0):scale(1):450:easeInQuad]:delay-200">
									<svg viewBox="0 0 100 100" init-with="p:[tro:center center, tr:scale(0)]"
							...
							<li class="pf-ab-shop-anim">
								<a class="pf-household" init-with="p:[transform:scale(0), tro: center center]"
									when-shop-sect-init="p:[transform:scale(0):scale(1):450:easeInQuad]:delay-300">
									<svg viewBox="0 0 100 100" init-with="p:[tro:center center, tr:scale(0)]"
							...
							<li class="pf-ab-shop-anim">
								<a class="pf-tech" init-with="p:[transform:scale(0), tro: center center]"
									when-shop-sect-init="p:[transform:scale(0):scale(1):450:easeInQuad]:delay-400">
									<svg viewBox="0 0 100 100" init-with="p:[tro:center center, tr:scale(0)]"
			...
			<div class="pf-resources pf-main-section" ng-class="{'active': guru.section_index === 3}">
				...
				<ul class="pf-items">
					<li>
						<div class="pf-tile-container mobile"
							init-with="p:[tro:left top, tr:rotateX(-30deg) rotateY(30deg), op:0]"
							when-pf-rs-init="s:[academic-cardlet-init-1:public]"
							when-academic-cardlet-init-1="p:[transform:rotateX(-30deg) rotateY(30deg):rotateX(0deg) rotateY(0deg):1000:easeOutCubic easeOutExpo, opacity:0:1:500:easeOutSine]"
							when-academic-cardlet-exit="p:[transform:rotateX(0deg) rotateY(0deg):rotateX(-30deg) rotateY(30deg):1000:easeOutSine easeOutSine, opacity:1:0:1500:easeOutSine]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-cardlet highlight bg-academic">
					...
					<li>
						<div class="pf-tile-container mobile"
							init-with="p:[tro:left top, tr:rotateX(-30deg) rotateY(30deg), op:0]"
							when-pf-rs-init="s:[academic-cardlet-init-2:public:delay-500]"
							when-academic-cardlet-init-2="p:[transform:rotateX(-30deg) rotateY(30deg):rotateX(0deg) rotateY(0deg):1000:easeOutCubic easeOutExpo, opacity:0:1:500:easeOutSine]"
							when-academic-cardlet-exit="p:[transform:rotateX(0deg) rotateY(0deg):rotateX(-30deg) rotateY(30deg):1000:easeOutSine easeOutSine, opacity:1:0:1500:easeOutSine]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-cardlet highlight bg-academic">
					...
					<li>
						<div class="pf-tile-container mobile"
							init-with="p:[tro:left top, tr:rotateX(-30deg) rotateY(30deg), op:0]"
							when-pf-rs-init="s:[academic-cardlet-init-3:public:delay-1000]"
							when-academic-cardlet-init-3="p:[transform:rotateX(-30deg) rotateY(30deg):rotateX(0deg) rotateY(0deg):1000:easeOutCubic easeOutExpo, opacity:0:1:500:easeOutSine]"
							when-academic-cardlet-exit="p:[transform:rotateX(0deg) rotateY(0deg):rotateX(-30deg) rotateY(30deg):1000:easeOutSine easeOutSine, opacity:1:0:1500:easeOutSine]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-cardlet highlight bg-academic">
								<div class="pf-cardlet-front-container">
								...
								<div class="pf-cardlet-bottom-container">
									<div class="pf-cardlet-bottom">
										...
										<div class="pf-cardlet-border deco">
											...
											<div init-with="p:[tr:scaleY(0)]"
												when-academic-cardlet-init-3="p:[transform:scaleY(0):scaleY(1):1450:easeOutSine]"></div>
											<div init-with="p:[tr:scaleY(0)]"
												when-academic-cardlet-init-3="p:[transform:scaleY(0):scaleY(1):1450:easeOutSine]"></div>
											<div init-with="p:[tr:scaleX(0)]"
												when-academic-cardlet-init-3="p:[transform:scaleX(0):scaleX(1):1450:easeOutSine]"></div>
										...
										<div>
											<div init-with="p:[op:0, tr:scaleY(0)]"
												when-academic-cardlet-init-3="p:[opacity:0:1:400:easeOutSine, transform:scaleY(0):scaleY(1):400:easeOutSine]:delay-650">
												<h2>03/28/2016</h2>
											</div>
										</div>
									</div>
					...
					<li>
						<div class="pf-tile-container mobile"
							init-with="p:[tro:left top, tr:rotateX(-30deg) rotateY(30deg), op:0]"
							when-pf-rs-init="s:[academic-cardlet-init-4:public:delay-1500]"
							when-academic-cardlet-init-4="p:[transform:rotateX(-30deg) rotateY(30deg):rotateX(0deg) rotateY(0deg):1000:easeOutCubic easeOutExpo, opacity:0:1:500:easeOutSine]"
							when-academic-cardlet-exit="p:[transform:rotateX(0deg) rotateY(0deg):rotateX(-30deg) rotateY(30deg):1000:easeOutSine easeOutSine, opacity:1:0:1500:easeOutSine]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-cardlet highlight bg-academic">
								<div class="pf-cardlet-front-container">
								...
								<div class="pf-cardlet-bottom-container">
									<div class="pf-cardlet-bottom">
										...
										<div class="pf-cardlet-border deco">
											...
											<div init-with="p:[tr:scaleY(0)]"
												when-academic-cardlet-init-4="p:[transform:scaleY(0):scaleY(1):1450:easeOutSine]"></div>
											<div init-with="p:[tr:scaleY(0)]"
												when-academic-cardlet-init-4="p:[transform:scaleY(0):scaleY(1):1450:easeOutSine]"></div>
											<div init-with="p:[tr:scaleX(0)]"
												when-academic-cardlet-init-4="p:[transform:scaleX(0):scaleX(1):1450:easeOutSine]"></div>
										...
										<div>
											<div init-with="p:[op:0, tr:scaleY(0)]"
												when-academic-cardlet-init-4="p:[opacity:0:1:400:easeOutSine, transform:scaleY(0):scaleY(1):400:easeOutSine]:delay-650">
												<h2>03/28/2016</h2>
											</div>
										</div>
									</div>
					...
					<li>
						<div class="pf-tile-container mobile"
							init-with="p:[tro:left top, tr:rotateX(-30deg) rotateY(30deg), op:0]"
							when-pf-rs-init="s:[academic-cardlet-init-5:public:delay-2000]"
							when-academic-cardlet-init-5="p:[transform:rotateX(-30deg) rotateY(30deg):rotateX(0deg) rotateY(0deg):1000:easeOutCubic easeOutExpo, opacity:0:1:500:easeOutSine]"
							when-academic-cardlet-exit="p:[transform:rotateX(0deg) rotateY(0deg):rotateX(-30deg) rotateY(30deg):1000:easeOutSine easeOutSine, opacity:1:0:1500:easeOutSine]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-cardlet highlight bg-academic">
								<div class="pf-cardlet-front-container">
								...
								<div class="pf-cardlet-bottom-container">
									<div class="pf-cardlet-bottom">
										...
										<div class="pf-cardlet-border deco">
											...
											<div init-with="p:[tr:scaleY(0)]"
												when-academic-cardlet-init-5="p:[transform:scaleY(0):scaleY(1):1450:easeOutSine]"></div>
											<div init-with="p:[tr:scaleY(0)]"
												when-academic-cardlet-init-5="p:[transform:scaleY(0):scaleY(1):1450:easeOutSine]"></div>
											<div init-with="p:[tr:scaleX(0)]"
												when-academic-cardlet-init-5="p:[transform:scaleX(0):scaleX(1):1450:easeOutSine]"></div>
										...
										<div>
											<div init-with="p:[op:0, tr:scaleY(0)]"
												when-academic-cardlet-init-5="p:[opacity:0:1:400:easeOutSine, transform:scaleY(0):scaleY(1):400:easeOutSine]:delay-650">
												<h2>03/28/2016</h2>
											</div>
										</div>
									</div>
					...
					<li>
						<div class="pf-tile-container mobile"
							init-with="p:[tro:left top, tr:rotateX(-30deg) rotateY(30deg), op:0]"
							when-pf-rs-init="s:[academic-cardlet-init-6:public:delay-2500]"
							when-academic-cardlet-init-6="p:[transform:rotateX(-30deg) rotateY(30deg):rotateX(0deg) rotateY(0deg):1000:easeOutCubic easeOutExpo, opacity:0:1:500:easeOutSine]"
							when-academic-cardlet-exit="p:[transform:rotateX(0deg) rotateY(0deg):rotateX(-30deg) rotateY(30deg):1000:easeOutSine easeOutSine, opacity:1:0:1500:easeOutSine]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-cardlet highlight bg-academic">
								<div class="pf-cardlet-front-container">
								...
								<div class="pf-cardlet-bottom-container">
									<div class="pf-cardlet-bottom">
										...
										<div class="pf-cardlet-border deco">
											...
											<div init-with="p:[tr:scaleY(0)]"
												when-academic-cardlet-init-6="p:[transform:scaleY(0):scaleY(1):1450:easeOutSine]"></div>
											<div init-with="p:[tr:scaleY(0)]"
												when-academic-cardlet-init-6="p:[transform:scaleY(0):scaleY(1):1450:easeOutSine]"></div>
											<div init-with="p:[tr:scaleX(0)]"
												when-academic-cardlet-init-6="p:[transform:scaleX(0):scaleX(1):1450:easeOutSine]"></div>
										...
										<div>
											<div init-with="p:[op:0, tr:scaleY(0)]"
												when-academic-cardlet-init-6="p:[opacity:0:1:400:easeOutSine, transform:scaleY(0):scaleY(1):400:easeOutSine]:delay-650">
												<h2>03/28/2016</h2>
											</div>
										</div>
									</div>
