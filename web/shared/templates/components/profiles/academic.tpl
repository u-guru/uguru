			...
			<div class="pf-portfolio pf-main-section" ng-class="{'active': guru.section_index === 1}">
				...
				<ul class="pf-items">
					...
					<li>
						<div class="pf-tile-container"
							init-with="p:[op:0, tro:left top, tr:rotateX(30deg) rotateY(30deg) translateY(300px)]"
							when-pf-sv-init="s:[academic-tile-init-2:public:delay-1000]"
							when-academic-tile-init-2="p:[transform:rotateX(30deg) rotateY(30deg) translateY(300px):rotateX(0deg) rotateY(0deg) translateY(0px):1000:easeOutCubic easeOutCubic easeOutExpo,opacity:0:1:10:linear]"
							when-academic-tile-exit="p:[tro:left bottom, opacity:1:0:500:easeOutSine:delay-500, transform:rotateX(0deg) rotateY(0deg) translateY(0px):rotateX(-45deg) rotateY(30deg) translateY(-300px):1000:easeOutCubic]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-tile bg-academic">
					...
					<li>
						<div class="pf-tile-container"
							init-with="p:[op:0, tro:left top, tr:rotateX(30deg) rotateY(30deg) translateY(300px)]"
							when-pf-sv-init="s:[academic-tile-init-3:public:delay-1500]"
							when-academic-tile-init-3="p:[transform:rotateX(30deg) rotateY(30deg) translateY(300px):rotateX(0deg) rotateY(0deg) translateY(0px):1000:easeOutCubic easeOutCubic easeOutExpo,opacity:0:1:10:linear]"
							when-academic-tile-exit="p:[tro:left bottom, opacity:1:0:500:easeOutSine:delay-500, transform:rotateX(0deg) rotateY(0deg) translateY(0px):rotateX(-45deg) rotateY(30deg) translateY(-300px):1000:easeOutCubic]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-tile bg-academic">
								<div class="pf-tile-border">
									<div class="top"
										init-with="p:[tro:left center, tr:scaleX(0)]"
										when-academic-tile-init-3="p:[transform:scaleX(0):scaleX(1):500:easeOutCubic]:delay-500"
										when-academic-tile-exit="p:[transform:scaleX(1):scaleX(0):500:easeOutCubic]"></div>
									<div class="right"
										init-with="p:[tro:center bottom, tr:scaleY(0)]"
										when-academic-tile-init-3="p:[transform:scaleY(0):scaleY(1):500:easeOutCubic]:delay-500"
										when-academic-tile-exit="p:[tr:scaleY(0)]"></div>
									<div class="bot"
										init-with="p:[tro:right center, tr:scaleX(0)]"
										when-academic-tile-init-3="p:[transform:scaleX(0):scaleX(1):500:easeOutCubic]:delay-500"
					...
					<li>
						<div class="pf-tile-container"
							init-with="p:[op:0, tro:left top, tr:rotateX(30deg) rotateY(30deg) translateY(300px)]"
							when-pf-sv-init="s:[academic-tile-init-4:public:delay-2000]"
							when-academic-tile-init-4="p:[transform:rotateX(30deg) rotateY(30deg) translateY(300px):rotateX(0deg) rotateY(0deg) translateY(0px):1000:easeOutCubic easeOutCubic easeOutExpo,opacity:0:1:10:linear]"
							when-academic-tile-exit="p:[tro:left bottom, opacity:1:0:500:easeOutSine:delay-500, transform:rotateX(0deg) rotateY(0deg) translateY(0px):rotateX(-45deg) rotateY(30deg) translateY(-300px):1000:easeOutCubic]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-tile bg-academic">
								<div class="pf-tile-border">
									<div class="top"
										init-with="p:[tro:left center, tr:scaleX(0)]"
										when-academic-tile-init-4="p:[transform:scaleX(0):scaleX(1):500:easeOutCubic]:delay-500"
										when-academic-tile-exit="p:[transform:scaleX(1):scaleX(0):500:easeOutCubic]"></div>
									<div class="right"
										init-with="p:[tro:center bottom, tr:scaleY(0)]"
										when-academic-tile-init-4="p:[transform:scaleY(0):scaleY(1):500:easeOutCubic]:delay-500"
										when-academic-tile-exit="p:[tr:scaleY(0)]"></div>
									<div class="bot"
										init-with="p:[tro:right center, tr:scaleX(0)]"
										when-academic-tile-init-4="p:[transform:scaleX(0):scaleX(1):500:easeOutCubic]:delay-500"
					...
					<li>
						<div class="pf-tile-container"
							init-with="p:[op:0, tro:left top, tr:rotateX(30deg) rotateY(30deg) translateY(300px)]"
							when-pf-sv-init="s:[academic-tile-init-5:public:delay-2500]"
							when-academic-tile-init-5="p:[transform:rotateX(30deg) rotateY(30deg) translateY(300px):rotateX(0deg) rotateY(0deg) translateY(0px):1000:easeOutCubic easeOutCubic easeOutExpo,opacity:0:1:10:linear]"
							when-academic-tile-exit="p:[tro:left bottom, opacity:1:0:500:easeOutSine:delay-500, transform:rotateX(0deg) rotateY(0deg) translateY(0px):rotateX(-45deg) rotateY(30deg) translateY(-300px):1000:easeOutCubic]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-tile bg-academic">
								<div class="pf-tile-border">
									<div class="top"
										init-with="p:[tro:left center, tr:scaleX(0)]"
										when-academic-tile-init-5="p:[transform:scaleX(0):scaleX(1):500:easeOutCubic]:delay-500"
										when-academic-tile-exit="p:[transform:scaleX(1):scaleX(0):500:easeOutCubic]"></div>
									<div class="right"
										init-with="p:[tro:center bottom, tr:scaleY(0)]"
										when-academic-tile-init-5="p:[transform:scaleY(0):scaleY(1):500:easeOutCubic]:delay-500"
										when-academic-tile-exit="p:[tr:scaleY(0)]"></div>
									<div class="bot"
										init-with="p:[tro:right center, tr:scaleX(0)]"
										when-academic-tile-init-5="p:[transform:scaleX(0):scaleX(1):500:easeOutCubic]:delay-500"
					...
					<li>
						<div class="pf-tile-container"
							init-with="p:[op:0, tro:left top, tr:rotateX(30deg) rotateY(30deg) translateY(300px)]"
							when-pf-sv-init="s:[academic-tile-init-6:public:delay-3000]"
							when-academic-tile-init-6="p:[transform:rotateX(30deg) rotateY(30deg) translateY(300px):rotateX(0deg) rotateY(0deg) translateY(0px):1000:easeOutCubic easeOutCubic easeOutExpo,opacity:0:1:10:linear]"
							when-academic-tile-exit="p:[tro:left bottom, opacity:1:0:500:easeOutSine:delay-500, transform:rotateX(0deg) rotateY(0deg) translateY(0px):rotateX(-45deg) rotateY(30deg) translateY(-300px):1000:easeOutCubic]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-tile bg-academic">
								<div class="pf-tile-border">
									<div class="top"
										init-with="p:[tro:left center, tr:scaleX(0)]"
										when-academic-tile-init-6="p:[transform:scaleX(0):scaleX(1):500:easeOutCubic]:delay-500"
										when-academic-tile-exit="p:[transform:scaleX(1):scaleX(0):500:easeOutCubic]"></div>
									<div class="right"
										init-with="p:[tro:center bottom, tr:scaleY(0)]"
										when-academic-tile-init-6="p:[transform:scaleY(0):scaleY(1):500:easeOutCubic]:delay-500"
										when-academic-tile-exit="p:[tr:scaleY(0)]"></div>
									<div class="bot"
										init-with="p:[tro:right center, tr:scaleX(0)]"
										when-academic-tile-init-6="p:[transform:scaleX(0):scaleX(1):500:easeOutCubic]:delay-500"
			...
			<div class="pf-resources pf-main-section" ng-class="{'active': guru.section_index === 3}">
				...
				<ul class="pf-items">
					<li>
						<div class="pf-tile-container"
							init-with="p:[op:0, tro:left top, tr:rotateX(30deg) rotateY(30deg) translateY(300px)]"
							when-pf-rs-init="s:[academic-cardlet-init-1:public:delay-1000]"
							when-academic-cardlet-init-1="p:[transform:rotateX(30deg) rotateY(30deg) translateY(300px):rotateX(0deg) rotateY(0deg) translateY(0px):1000:easeOutCubic easeOutCubic easeOutExpo,opacity:0:1:10:linear]"
							when-academic-cardlet-exit="p:[tro:left bottom, opacity:1:0:500:easeOutSine:delay-750, transform:rotateX(0deg) rotateY(0deg) translateY(0px):rotateX(-45deg) rotateY(30deg) translateY(-300px):1000:easeOutCubic:delay-250]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-cardlet highlight bg-academic">
					...
					<li>
						<div class="pf-tile-container"
							init-with="p:[op:0, tro:left top, tr:rotateX(30deg) rotateY(30deg) translateY(300px)]"
							when-pf-rs-init="s:[academic-cardlet-init-2:public:delay-1500]"
							when-academic-cardlet-init-2="p:[transform:rotateX(30deg) rotateY(30deg) translateY(300px):rotateX(0deg) rotateY(0deg) translateY(0px):1000:easeOutCubic easeOutCubic easeOutExpo,opacity:0:1:10:linear]"
							when-academic-cardlet-exit="p:[tro:left bottom, opacity:1:0:500:easeOutSine:delay-750, transform:rotateX(0deg) rotateY(0deg) translateY(0px):rotateX(-45deg) rotateY(30deg) translateY(-300px):1000:easeOutCubic:delay-250]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-cardlet highlight bg-academic">
					...
					<li>
						<div class="pf-tile-container"
							init-with="p:[op:0, tro:left top, tr:rotateX(30deg) rotateY(30deg) translateY(300px)]"
							when-pf-rs-init="s:[academic-cardlet-init-3:public:delay-2000]"
							when-academic-cardlet-init-3="p:[transform:rotateX(30deg) rotateY(30deg) translateY(300px):rotateX(0deg) rotateY(0deg) translateY(0px):1000:easeOutCubic easeOutCubic easeOutExpo,opacity:0:1:10:linear]"
							when-academic-cardlet-exit="p:[tro:left bottom, opacity:1:0:500:easeOutSine:delay-750, transform:rotateX(0deg) rotateY(0deg) translateY(0px):rotateX(-45deg) rotateY(30deg) translateY(-300px):1000:easeOutCubic:delay-250]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-cardlet highlight bg-academic">
								<div class="pf-cardlet-front-container"
									init-with="p:[tr:translateX(7.5px) translateY(7.5px) translateZ(0px)]"
									when-academic-cardlet-init-3="p:[transform:translateX(7.5px) translateY(7.5px):translateX(0px) translateY(0px):450:easeOutSine]:delay-750">
									<div class="pf-cardlet-front" style="background-image: url('http://i1-news.softpedia-static.com/images/news2/no-two-brains-are-alike-investigation-reveals-494462-2.jpg');"></div>
								</div>
								<div class="pf-cardlet-back-container"
									init-with="p:[tr:translateX(-7.5px) translateY(-7.5px) translateZ(0px)]"
								...
								<div class="pf-cardlet-ribbon-container"
									init-with="p:[op:0, tr:translateX(10px)]"
									when-academic-cardlet-init-3="p:[opacity:0:1:250:easeOutSine, transform:translateX(10px):translateX(0px):250:easeOutSine]:delay-500">
									<div class="pf-cardlet-ribbon">
										<svg viewBox="0 0 100 100">
											<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118 "></polygon>
										</svg>
					...
					<li>
						<div class="pf-tile-container"
							init-with="p:[op:0, tro:left top, tr:rotateX(30deg) rotateY(30deg) translateY(300px)]"
							when-pf-rs-init="s:[academic-cardlet-init-4:public:delay-2500]"
							when-academic-cardlet-init-4="p:[transform:rotateX(30deg) rotateY(30deg) translateY(300px):rotateX(0deg) rotateY(0deg) translateY(0px):1000:easeOutCubic easeOutCubic easeOutExpo,opacity:0:1:10:linear]"
							when-academic-cardlet-exit="p:[tro:left bottom, opacity:1:0:500:easeOutSine:delay-750, transform:rotateX(0deg) rotateY(0deg) translateY(0px):rotateX(-45deg) rotateY(30deg) translateY(-300px):1000:easeOutCubic:delay-250]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-cardlet highlight bg-academic">
								<div class="pf-cardlet-front-container"
									init-with="p:[tr:translateX(7.5px) translateY(7.5px) translateZ(0px)]"
									when-academic-cardlet-init-4="p:[transform:translateX(7.5px) translateY(7.5px):translateX(0px) translateY(0px):450:easeOutSine]:delay-750">
									<div class="pf-cardlet-front" style="background-image: url('http://i1-news.softpedia-static.com/images/news2/no-two-brains-are-alike-investigation-reveals-494462-2.jpg');"></div>
								</div>
								<div class="pf-cardlet-back-container"
									init-with="p:[tr:translateX(-7.5px) translateY(-7.5px) translateZ(0px)]"
								...
								<div class="pf-cardlet-ribbon-container"
									init-with="p:[op:0, tr:translateX(10px)]"
									when-academic-cardlet-init-4="p:[opacity:0:1:250:easeOutSine, transform:translateX(10px):translateX(0px):250:easeOutSine]:delay-500">
									<div class="pf-cardlet-ribbon">
										<svg viewBox="0 0 100 100">
											<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118 "></polygon>
										</svg>
					...
					<li>
						<div class="pf-tile-container"
							init-with="p:[op:0, tro:left top, tr:rotateX(30deg) rotateY(30deg) translateY(300px)]"
							when-pf-rs-init="s:[academic-cardlet-init-5:public:delay-3000]"
							when-academic-cardlet-init-5="p:[transform:rotateX(30deg) rotateY(30deg) translateY(300px):rotateX(0deg) rotateY(0deg) translateY(0px):1000:easeOutCubic easeOutCubic easeOutExpo,opacity:0:1:10:linear]"
							when-academic-cardlet-exit="p:[tro:left bottom, opacity:1:0:500:easeOutSine:delay-750, transform:rotateX(0deg) rotateY(0deg) translateY(0px):rotateX(-45deg) rotateY(30deg) translateY(-300px):1000:easeOutCubic:delay-250]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-cardlet highlight bg-academic">
								<div class="pf-cardlet-front-container"
									init-with="p:[tr:translateX(7.5px) translateY(7.5px) translateZ(0px)]"
									when-academic-cardlet-init-5="p:[transform:translateX(7.5px) translateY(7.5px):translateX(0px) translateY(0px):450:easeOutSine]:delay-750">
									<div class="pf-cardlet-front" style="background-image: url('http://i1-news.softpedia-static.com/images/news2/no-two-brains-are-alike-investigation-reveals-494462-2.jpg');"></div>
								</div>
								<div class="pf-cardlet-back-container"
									init-with="p:[tr:translateX(-7.5px) translateY(-7.5px) translateZ(0px)]"
								...
								<div class="pf-cardlet-ribbon-container"
									init-with="p:[op:0, tr:translateX(10px)]"
									when-academic-cardlet-init-5="p:[opacity:0:1:250:easeOutSine, transform:translateX(10px):translateX(0px):250:easeOutSine]:delay-500">
									<div class="pf-cardlet-ribbon">
										<svg viewBox="0 0 100 100">
											<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118 "></polygon>
										</svg>
					...
					<li>
						<div class="pf-tile-container"
							init-with="p:[op:0, tro:left top, tr:rotateX(30deg) rotateY(30deg) translateY(300px)]"
							when-pf-rs-init="s:[academic-cardlet-init-6:public:delay-3500]"
							when-academic-cardlet-init-6="p:[transform:rotateX(30deg) rotateY(30deg) translateY(300px):rotateX(0deg) rotateY(0deg) translateY(0px):1000:easeOutCubic easeOutCubic easeOutExpo,opacity:0:1:10:linear]"
							when-academic-cardlet-exit="p:[tro:left bottom, opacity:1:0:500:easeOutSine:delay-750, transform:rotateX(0deg) rotateY(0deg) translateY(0px):rotateX(-45deg) rotateY(30deg) translateY(-300px):1000:easeOutCubic:delay-250]">
							<a></a><a></a><a></a><a></a>
							<div class="pf-cardlet highlight bg-academic">
								<div class="pf-cardlet-front-container"
									init-with="p:[tr:translateX(7.5px) translateY(7.5px) translateZ(0px)]"
									when-academic-cardlet-init-6="p:[transform:translateX(7.5px) translateY(7.5px):translateX(0px) translateY(0px):450:easeOutSine]:delay-750">
									<div class="pf-cardlet-front" style="background-image: url('http://i1-news.softpedia-static.com/images/news2/no-two-brains-are-alike-investigation-reveals-494462-2.jpg');"></div>
								</div>
								<div class="pf-cardlet-back-container"
									init-with="p:[tr:translateX(-7.5px) translateY(-7.5px) translateZ(0px)]"
								...
								<div class="pf-cardlet-ribbon-container"
									init-with="p:[op:0, tr:translateX(10px)]"
									when-academic-cardlet-init-6="p:[opacity:0:1:250:easeOutSine, transform:translateX(10px):translateX(0px):250:easeOutSine]:delay-500">
									<div class="pf-cardlet-ribbon">
										<svg viewBox="0 0 100 100">
											<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118 "></polygon>
										</svg>
