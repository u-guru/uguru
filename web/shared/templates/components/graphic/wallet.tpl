<div class="perspective-container full-xy flex-center p15xy">
	<div class="wallet-container"
		...
		on-init="a:[bounceInLeft-subtle:set:(dur:1000ms#func:linear):in] | send:[wallet-enter:public]">
		...
		<svg class="wallet-exterior absolute top-0 left-0" viewBox="0 0 264 199">
			<g fill="none" fill-rule="evenodd" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"
				...
				when-wallet-enter="p:[transform:rotateY(120deg):rotateY(0deg):650:easeOutQuad:delay-250]">
		...
		<svg class="wallet-latch absolute top-0 left-0" viewBox="0 0 264 199">
			<g fill="none" fill-rule="evenodd" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"
				...
				when-wallet-enter="p:[transform:rotateY(120deg) rotateX(5deg):rotateY(0deg) rotateX(0deg):650:easeOutBack]:delay-450">
		...
		<div>
			<h1 init-with="p-op"
				when-wallet-enter="a:[fadeIn:set:(dur:800ms#func:cubic-bezier(.8#.1#1#.05)):in:delay-450]">My Wallet</h1>
			<button init-with="p-op"
				when-wallet-enter="a:[bounceIn-subtle:set:(dur:1000ms#func:linear):in:delay-450]">Add&nbsp;Card</button>
		</div>
	</div>
</div>
