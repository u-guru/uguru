<div class="perspective-container full-xy flex-center p15xy">
	<a class="attachment-tile overflow-hidden" style="width: 350px"
		...
		<div class="attachment-tile-desc"
			...
			<h3 u init-with="p-op"
				when-attachment-tile-init="a:[bounceInUp-subtle:1000:linear:1000:1:f]">ingredients.pdf</h3>
			<p u init-with="p-op"
				when-attachment-tile-init="a:[bounceInUp-subtle:1000:linear:1100:1:f]">A list of my ingredients in case of allergies or other restrictions.</p>
		</div>
	</a>
</div>
