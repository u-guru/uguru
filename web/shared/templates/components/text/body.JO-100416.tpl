<div class="perspective-container full-xy flex-center p15xy bg-white" reference="http://codepen.io/teamuguru/pen/b96acb7823f68a8dadc95e01abea94a6?editors=1100">
	<div class="body-text" number="3" style="max-width: 360px"
		...
		<div class="body-text-loader"
			...
			<span u init-with="p:[opacity:0, width:70%]"
				when-body-text-init="a:[opacity:0:1:150:easeOutSine:0:1:f]">
				<span u init-with="p:[transform:scaleX(0)]"
			...
			<span u init-with="p:[opacity:0, width:95%]"
				when-body-text-init="a:[opacity:0:1:150:easeOutSine:0:1:f]">
				<span u init-with="p:[transform:scaleX(0)]"
					when-body-text-init="a:[scaleX:0:1:450:easeOutSine:0:1:f]"></span>
			</span>
			<span u init-with="p:[opacity:0, width:85%]"
				when-body-text-init="a:[opacity:0:1:150:easeOutSine:0:1:f]">
				<span u init-with="p:[transform:scaleX(0)]"
					when-body-text-init="a:[scaleX:0:1:450:easeOutSine:0:1:f]"></span>
			</span>
		...
		<span u init-with="p:[opacity:0]"
			when-body-text-init="a:[opacity:0:1:150:easeOutSine:600:1:f]">Lorem ipsum dolor sit amet.</span>
		<span u init-with="p:[opacity:0]"
			when-body-text-init="a:[opacity:0:1:150:easeOutSine:600:1:f]">Consectetuer adipiscing elit eget nisl.</span>
		<span u init-with="p:[opacity:0]"
			when-body-text-init="a:[opacity:0:1:150:easeOutSine:600:1:f]">Nam at tortor quis ipsum tempor.</span>
	</div>
