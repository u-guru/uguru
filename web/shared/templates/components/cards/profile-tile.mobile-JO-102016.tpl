<div class="perspective-container full-xy flex-center p15xy" types='academic, baking, photo, tech, household' default-type="baking">
	<div class="pf-tile-container mobile" ng-if='activeType === "academic"'
		u on-init="s:[academic-tile-init:public]">
		<a></a><a></a><a></a><a></a>
		<div class="pf-tile bg-academic"
			u init-with="p:[background:rgba(99#112#116#0.2)]"
			when-academic-tile-init="a:[background:rgba(99#112#116#0):rgba(99#112#116#1):500:easeOutSine:0:1:f]:delay-650"
			when-academic-tile-exit="a:[opacity:1:0:1500:easeOutQuad:0:1:f]:delay-1000">
			<div class="pf-tile-border"
				u init-with="p:[transform-origin:left top, transform:rotateX(-30deg) rotateY(30deg), opacity:0]"
				when-academic-tile-init="a:[opacity:0:0.5:500:easeOutSine:0:1:f, rotateX:-30deg:0deg:1000:easeOutCubic:0:1:f, rotateY:30deg:0deg:1000:easeOutCubic:0:1:f]"
				when-academic-tile-exit="a:[rotateX:0deg:-30deg:1000:easeOutCubic:1500:1:f, rotateY:0deg:30deg:1000:easeOutCubic:1500:1:f, opacity:1:0:1000:easeOutSine:1500:1:f]">
				<div class="top"></div>
				<div class="right"></div>
				<div class="bot"></div>
				<div class="left"></div>
			...
			<div class="pf-tile-top"
				u init-with="p:[bg:rgba(99#112#116#0)]"
				when-academic-tile-init="a:[background:rgba(99#112#116#0):rgba(99#112#116#1):500:easeOutSine]:delay-650"
				when-academic-tile-exit="a:[opacity:1:0:1500:easeOutCubic]:delay-1000">
				<div class="pf-pricing"
					u init-with="p:[opacity:0]"
					when-academic-tile-init="a:[opacity:0:1:500:easeOutSine:900:1:f]">$10/hr</div>
				<div class="pf-tile-icon"
					u init-with="p:[transform:translateY(-100px), opacity:0]"
					when-academic-tile-init="a:[opacity:0:1:750:easeOutSine:750:1:f, translateY:-100px:0px:750:easeOutSine:750:1:f]"
					when-academic-tile-exit="a:[opacity:1:0:750:easeOutSine:750:1:f]">
				...
				<h1 u init-with="p:[opacity:0, transform:translateY(-100px)]"
					when-academic-tile-init="a:[opacity:0:1:750:easeOutSine:500:1:f, translateY:-100px:0px:750:easeOutSine:750:1:f]"
					when-academic-tile-exit="a:[opacity:1:0:750:easeOutSine:750:1:f]">Chem 133</h1>
				<h2 u init-with="p:[opacity:0, transform:translateY(-100px)]"
					when-academic-tile-init="a:[opacity:0:1:750:easeOutSine:500:1:f, translateY:-100px:0px:750:easeOutSine:500:1:f]"
					when-academic-tile-exit="a:[opacity:1:0:750:easeOutSine:750:1:f]">Organic Chemistry</h2>
			</div>
			<div class="pf-tile-bottom"
				...
				when-academic-tile-exit="a:[opacity:1:0:1500:easeOutCubic:750:1:f]">
				<ul class="rating-stars" data-rating="4" data-half="true">
					<li u init-with="p:[opacity:0]"
						when-academic-tile-init="a:[pf-bounceIn-rotate:500:easeOutSine:1400:1:f]">
						<svg viewBox="0 0 100 100">
		...
		<div class="pf-tile bg-baking">
			<div class="pf-tile-top" style="background-image: url('https://scontent.cdninstagram.com/hphotos-xfa1/t51.2885-15/e15/11427260_752534584858053_1867976098_n.jpg');"
				...
				<div class="full-x flex-center preserve-3d m15bottom"
					init-with="p:[transform-origin:center top, rotateX(180deg)]"
					when-baking-tile-init="p:[rotateX(180deg):rotateX(0deg):1000:easeInOutQuint, opacity:0:1:100:easeInOutQuint]"
					when-baking-tile-exit="p:[rotateX(0deg):rotateX(180deg):1000:easeInOutQuint]">
					<h1>
						...
						<ul class="rating-stars" data-rating="4" data-half="true">
							<li u init-with="p:[opacity:0]"
								when-baking-tile-init="a:[pf-bounceIn-rotate:500:easeOutSine:1400]">
								<svg viewBox="0 0 100 100">
									<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
									<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
								</svg>
							...
							<li u init-with="p:[opacity:0]"
								when-baking-tile-init="a:[pf-bounceIn-rotate:500:easeOutSine:1500]">
								<svg viewBox="0 0 100 100">
									<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
									<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
								</svg>
							...
							<li u init-with="p:[opacity:0]"
								when-baking-tile-init="a:[pf-bounceIn-rotate:500:easeOutSine:1600]">
								<svg viewBox="0 0 100 100">
									<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
									<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
								</svg>
							...
							<li u init-with="p:[opacity:0]"
								when-baking-tile-init="a:[pf-bounceIn-rotate:500:easeOutSine:1700]">
								<svg viewBox="0 0 100 100">
									<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
									<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
								</svg>
							...
							<li u init-with="p:[opacity:0]"
								when-baking-tile-init="a:[pf-bounceIn-rotate:500:easeOutSine:1800]">
								<svg viewBox="0 0 100 100">
									<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
									<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
								</svg>
				...
				<div>
					<div class="pf-pricing large"
						u init-with="p:[opacity:0]"
						when-baking-tile-init="a:[pf-jelly:1000:cubic-bezier(.43#-0.06#.68#1.23):1000]"
						when-baking-tile-exit="a:[pf-jelly:1000ms#dir:reverse#func:cubic-bezier(.43#-0.06#.68#1.23)):out]">
	...
	<div class="pf-tile-container mobile" ng-if='activeType === "photo"'
		init-with="p:[transform-origin:left top, rotateX(-30deg) rotateY(30deg), opacity:0]"
		on-init="s:[photo-tile-init:public]"
		when-photo-tile-init="a:[rotateX:-30deg:0deg:1000:easeOutCubic:1:f, rotateY:30deg:0deg:1000:easeOutExpo:0:1:f, opacity:0:1:500:easeOutSine:0:1:f]"
		...
		<div class="pf-tile bg-photography">
			...
			<div class="pf-tile-bottom">
				...
				<ul class="rating-stars" data-rating="4" data-half="true">
					<li u init-with="p:[opacity:0]"
						when-photo-tile-init="a:[pf-bounceIn-rotate:500:easeOutSine:1100]">
						<svg viewBox="0 0 100 100">
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
						</svg>
					...
					<li u init-with="p:[opacity:0]"
						when-photo-tile-init="a:[pf-bounceIn-rotate:500:easeOutSine:1200]">
						<svg viewBox="0 0 100 100">
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
						</svg>
					...
					<li u init-with="p:[opacity:0]"
						when-photo-tile-init="a:[pf-bounceIn-rotate:500:easeOutSine:1300]">
						<svg viewBox="0 0 100 100">
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
						</svg>
					...
					<li u init-with="p:[opacity:0]"
						when-photo-tile-init="a:[pf-bounceIn-rotate:500:easeOutSine:1400]">
						<svg viewBox="0 0 100 100">
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
						</svg>
					...
					<li u init-with="p:[opacity:0]"
						when-photo-tile-init="a:[pf-bounceIn-rotate:500:easeOutSine:1500]">
						<svg viewBox="0 0 100 100">
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
						</svg>
				...
				<div class="pf-pricing photo-price"
					...
					when-photo-tile-init="a:[slideInUp-subtle:1000:easeOutSine:1000]">
					<div class="pf-border">
						<div init-with="p:[scaleX(0)]"
							when-photo-tile-init="p:[scaleX(0):scaleX(1):250:easeOutSine]:delay-2000"></div>
						<div init-with="p:[scaleY(0)]"
							when-photo-tile-init="p:[scaleY(0):scaleY(1):250:easeOutSine]:delay-2000"></div>
						<div init-with="p:[scaleX(0)]"
							when-photo-tile-init="p:[scaleX(0):scaleX(1):250:easeOutSine]:delay-2000"></div>
						<div init-with="p:[scaleY(0)]"
							when-photo-tile-init="p:[scaleY(0):scaleY(1):250:easeOutSine]:delay-2000"></div>
		...
		<div class="pf-tile bg-tech">
			<div class="pf-tile-top" style="background-image: url('http://www.iphoneinformer.com/wp-content/uploads/2015/11/wet-iPhone-6-2.jpg');"
				...
				<div class="pf-pricing">
					...
					<div class="border border-corner">
						<span class="left"
							init-with="p:[scaleY(0)]"
							when-tech-tile-init="p:[scaleY(0):scaleY(1):500:easeOutBack]:delay-1250"
							when-tech-tile-exit="p:[scaleY(1):scaleY(0):500:easeOutBack]:delay-1000"></span>
						<span class="bot"
							init-with="p:[scaleX(0)]"
							when-tech-tile-init="p:[scaleX(0):scaleX(1):500:easeOutBack]:delay-1250"
							when-tech-tile-exit="p:[scaleX(1):scaleX(0):500:easeOutBack]:delay-1000"></span>
					</div>
				</div>
			</div>
			<div class="pf-tile-bottom"
				...
				<h1 init-with="p:[opacity:0, translateY(10px)]"
					when-tech-tile-init="p:[opacity:0:1:50:linear, translateY(10px):translateY(0px):500:easeOutExpo]:delay-450">Water Damage</h1>
				<ul class="rating-stars" data-rating="4" data-half="true">
					<li u init-with="p:[opacity:0]"
						when-tech-tile-init="a:[pf-bounceIn-rotate:500:easeOutSine:900]">
						<svg viewBox="0 0 100 100">
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
						</svg>
					...
					<li u init-with="p:[opacity:0]"
						when-tech-tile-init="a:[pf-bounceIn-rotate:500:easeOutSine:1000]">
						<svg viewBox="0 0 100 100">
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
						</svg>
					...
					<li u init-with="p:[opacity:0]"
						when-tech-tile-init="a:[pf-bounceIn-rotate:500:easeOutSine:1100]">
						<svg viewBox="0 0 100 100">
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
						</svg>
					...
					<li u init-with="p:[opacity:0]"
						when-tech-tile-init="a:[pf-bounceIn-rotate:500:easeOutSine:1200]">
						<svg viewBox="0 0 100 100">
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
						</svg>
					...
					<li u init-with="p:[opacity:0]"
						when-tech-tile-init="a:[pf-bounceIn-rotate:500:easeOutSine:1300]">
						<svg viewBox="0 0 100 100">
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14 60.5801345 35.4376941 84.2380346 38.8753882 67.1190173 55.5623059 71.1602691 79.1246118"></polygon>
							<polygon points="50 68 28.8397309 79.1246118 32.8809827 55.5623059 15.7619654 38.8753882 39.4198655 35.4376941 50 14"></polygon>
						</svg>
				...
				<div class="border border-top">
					<span class="left"
						init-with="p:[scaleX(0)]"
						when-tech-borders-init="p:[scaleX(0):scaleX(1):500:easeOutCubic]"
						when-tech-tile-exit="p:[opacity:0:delay-750, scaleX(0):delay-250]"></span>
					<span class="right"
						init-with="p:[scaleX(0)]"
						when-tech-borders-init="p:[scaleX(0):scaleX(1):500:easeOutCubic]"
						when-tech-tile-exit="p:[opacity:0:delay-750, scaleX(0):delay-250]"></span>
			...
			<div class="border border-outside">
				<span class="top-left"
					init-with="p:[scaleX(0)]"
					when-tech-borders-init="p:[scaleX(0):scaleX(1):500:easeOutCubic]"
					when-tech-tile-exit="p:[scaleX(1):scaleX(0):500:easeInCubic]:delay-800"></span>
				...
				<span class="right"
					init-with="p:[scaleY(0)]"
					when-tech-borders-init="p:[scaleY(0):scaleY(1):300:easeOutCubic]:delay-450"
					when-tech-tile-exit="p:[opacity:0:delay-800, scaleY(0):delay-500]"></span>
				<span class="bot-left"
					init-with="p:[scaleX(0)]"
					when-tech-borders-init="p:[scaleX(0):scaleX(1):500:easeOutCubic]:delay-750"
					when-tech-tile-exit="p:[opacity:0:delay-500, scaleX(0)]"></span>
