<div class="perspective-container full-xy flex-center p15xy">
	<a class="request-card bg-household complete"
		init-with="p-op"
		on-init="s:[request-card-init:public]"
		when-request-card-init="a:[bounceIn-subtle:set:(dur:1000ms#func:linear):in]">
		<div class="map">
			<div class="map-marker" style="bottom: 15px; left: 50%; margin-left: -6px;">
				<div>
					<div init-with="p-op"
						when-request-card-init="a:[bounceIn-subtle:set:(dur:1000ms#func:linear):in:delay-750] | p:[tro:center bottom]">
						<span init-with="p-op"
							when-request-card-init="p:[opacity:0:1:1000:easeOutSine]:delay-1000">
						...
						<span init-with="p-op"
							when-request-card-init="p:[opacity:0:1:1000:easeOutSine]:delay-1000">Philz Coffee</span>
					</div>
				</div>
				<span init-with="p-op"
					when-request-card-init="a:[bounceIn-subtle:set:(dur:1000ms#func:ease-out):in:delay-500]"></span>
			</div>
		</div>
		<div class="info">
			<hr class="info-border"
				init-with="p:[tr:scaleX(0), tro:center center]"
				when-request-card-init="p:[transform:scaleX(0):scaleX(1):250:easeOutSine]:delay-150"/>
			<ul class="ugrid-2">
				<li init-with="p-op"
					when-request-card-init="a:[icon-enter:set:(dur:800ms#func:linear):in:delay-350]">
				...
				<li init-with="p-op"
					when-request-card-init="p:[opacity:0:1:500:easeOutSine]:delay-350">
			...
			<ul class="ugrid-3"
				...
				<li init-with="p-op"
					when-request-card-init="a:[bounceIn-subtle:set:(dur:1000ms#func:ease-out):in:delay-500]">
