<div class="perspective-container full-xy flex-center p15xy">
	<article class="timeline-card timeline-tutorial timeline-left"
		...
		on-init="s:[timeline-card-init:public, chips:public]"
		when-timeline-card-init="a:[bounceInLeft-subtle:1000:linear:0:1:f]">
		<header>
			<a>
		...
		<section class="overflow-hidden">
				...
				<ul>
					<li>
						<a u init-with="p:[op:0, tro:center center]"
							when-timeline-card-init="a:[bounceInRight-subtle:1000:linear:1600:1:f]">
							<span>
					...
					<li>
						<a u init-with="p:[op:0, tro:center center]"
							when-timeline-card-init="a:[bounceInRight-subtle:1000:linear:1700:1:f]">
							<span>
								<svg viewBox="0 0 100 100">
					...
					<li>
						<a u init-with="p:[op:0, tro:center center]"
							when-timeline-card-init="a:[bounceInRight-subtle:1000:linear:1800:1:f]">
							<span>
								<svg viewBox="0 0 100 100">
			...
			<div class="tag-list">
				<ul init-after="chips" on-init="s:[timeline-chip:public:1800]">
					...
					<li u init-with="p:[op:0, tro:left top]"
						when-timeline-chip="a:[bounceInRight-subtle:1000:linear:0:1:f]:delay-100"><a class="chip bg bg-azure">tag</a></li>
					<li u init-with="p:[op:0, tro:left top]"
						when-timeline-chip="a:[bounceInRight-subtle:1000:linear:0:1:f]:delay-200"><a class="chip bg bg-azure">tag</a></li>
					<li u init-with="p:[op:0, tro:left top]"
						when-timeline-chip="a:[bounceInRight-subtle:1000:linear:0:1:f]:delay-300"><a class="chip bg bg-azure">tag</a></li>
				</ul>
			</div>
			<footer>
				<ul>
					<li u init-with="p:[op:0, tro:center center]"
						when-timeline-chip="a:[bounceInUp-subtle:1000:linear:1500:1:f]"><span class="user-icon-36"></span></li>
					<li u init-with="p:[op:0, tro:center center]"
						when-timeline-chip="a:[bounceInUp-subtle:1000:linear:1600:1:f]">
