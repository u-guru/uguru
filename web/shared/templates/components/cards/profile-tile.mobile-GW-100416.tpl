		...
		<div class="pf-tile bg-academic"
			...
			<div class="pf-tile-top"
				...
				<div class="pf-pricing"
					...
					when-academic-tile-init="p:[opacity:0:1:500:easeOutSine:900:1:f]">$10/hr</div>
				<div class="pf-tile-icon"
					u init-with="p:[translateY:-100px, opacity:0]"
					when-academic-tile-init="p:[opacity:0:1:750:easeOutSine:750:1:f, translateY:-100px:0px:750:easeOutSine:750:1:f]"
					when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine:750:1:f]">
				...
				<h1 u init-with="p:[opacity:0, translateY:-100px]"
					when-academic-tile-init="p:[opacity:0:1:750:easeOutSine:500:1:f, translateY:-100px:0px:750:easeOutSine:750:1:f]"
					when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine:750:1:f]">Chem 133</h1>
				<h2 u init-with="p:[opacity:0, translateY:-100px]"
					when-academic-tile-init="p:[opacity:0:1:750:easeOutSine:500:1:f, translateY:-100px:0px:750:easeOutSine:500:1:f]"
					when-academic-tile-exit="p:[opacity:1:0:750:easeOutSine:750:1:f]">Organic Chemistry</h2>
			</div>
			<div class="pf-tile-bottom"
				u init-with="p:[transform-origin:center bottom, opacity:0, translateY:-100px, scaleY:3]"
				when-academic-tile-init="p:[translateY:-100px:0px:1000:easeInOutCubic:0:1:f, scaleY:3:1:1000:easeInOutCubic:0:1:f, opacity:0:1:250:easeOutSine:250:1:f]"
				when-academic-tile-exit="p:[opacity:1:0:1500:easeOutCubic:750:1:f]">
