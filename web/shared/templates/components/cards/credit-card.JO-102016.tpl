<div class="perspective-container full-xy flex-center" types='flip, edit, short, mini' default-type="flip">
	<div class="card-container" ng-if='activeType === "flip"'>
		<div class="credit-card-flip"
			...
			on-init="a:[zoom-enter:1000:easeOutSine:0:1:f]| s:[credit-card-init:public]"
	                    ...
	                    <div class="credit-card-number-container">
							...
							<div class="credit-card-number has-span">
	                            ...
	                            <span u init-with="p:[op:0, tro:center center]"
									when-credit-card-init="a:[bounceIn-subtle:1000:easeOutSine:0:1:f]:delay-1500">1234</span>
	                        </div>
	                    </div>
	                    <div class="credit-card-row">
	                        <div>
	                            ...
	                            <div class="credit-card-number"
									...
									when-credit-card-init="a:[bounceIn-subtle:1000:easeOutSine:0:1:f]:delay-250">10/20</div>
	                        </div>
	...
	<div class="card-container" ng-if='activeType === "edit"'>
	    <div class="credit-card edit"
			init-with="p-op"
			on-init="s:[credit-card-init:public] | a:[scoop-enter:1000:easeOutSine:0:1:f]">
