<div class="perspective-container full-xy flex-center">
	<div class="card-container">
		<div class="credit-card-flip" tabindex
			...
			on-init="s:[credit-card-init:public] | a:[scoop-enter:1000:linear:100:1:f]"
							...
							<div class="credit-card-number has-span">
								<span>
									<stagger-children on-enter="[cc-number]:800:easeInQuad">
										<span cc-number
											u init-with="p:[scale:0, transform-origin:center center]"
								...
								<span u init-with="p:[opacity:0, transform-origin:center center]"
									when-credit-card-init="a:[bounceIn-subtle:1000:easeOutSine:1500:0:1:f]">1234</span>
							</div>
						</div>
						<div class="credit-card-row">
							<div>
								...
								<div class="credit-card-number"
									...
									when-credit-card-init="a:[bounceIn-subtle:1000:easeOutSine:250:1:f]">10/20</div>
							</div>
			...
			<div class="credit-card-back"
				u init-with="p:[rotateY:180deg]"
				when-flip-enter="p:[rotateY:180deg:0deg:300:easeInOutSine:1:f]"
				when-flip-leave="p:[rotateY:0deg:180deg:300:easeInOutSine:1:f]">
				<svg width="240px" height="150px" viewBox="0 0 240 150">
					<rect fill="none" x="0" y="0" width="240" height="150"></rect>
				</svg>
				<div></div>
				<ul>
					<li>
						<button class="remove"
							u init-with="p:[opacity:0]"
							when-flip-enter="a:[opacity:0:1:250:easeOutSine:300:1:f]"
							when-flip-leave="p:[opacity:1:0:250:easeOutSine:0:1:f]">Remove</button>
					</li>
					<li>
						<button class="default"
							u init-with="p:[opacity:0]"
							when-flip-enter="a:[opacity:0:1:250:easeOutSine:300:1:f]"
							when-flip-leave="p:[opacity:1:0:250:easeOutSine:0:1:f]">Set Default</button>
					</li>
				</ul>
			</div>
		</div>
