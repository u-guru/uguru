<div class="perspective-container full-xy flex-center p15xy"
	u on-init="s:[record-tile-init:public]">
	<div class="record-tile-container"
		...
		<a class="record-tile">
			...
			<div class="record-tile-back"
				...
				<div u init-with="p:[tro:center center, tr:rotate(0)]"
					when-record-tile-init="a:[rotate:0deg:40deg:1000:easeOutBack:0:1:f]:delay-1750">
					<svg viewBox="0 0 320 320" u init-with="p-op"
						when-record-tile-init="a:[opacity:0:1:500:easeOutQuint:0:1:f]:delay-250">
						<defs>
		...
		<div class="record-info">
			<h3 u init-with="p-op"
				when-record-tile-init="a:[slideInUp-subtle:1000:linear:1250:1:f]">Top 40 - 2016</h3>
		</div>
	</div>
</div>
