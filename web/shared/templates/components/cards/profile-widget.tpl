	...
	<div class="pf-aside-widget"
		...
		<stagger-children on-enter="[non-top]:+500">
			...
			<div class="right border-line"
				...
				on-init="t-enter"
				on-enter="p:[transform:scale(0):scale(1):500:easeOutQuart]"></div>
			<div class="bot-left border-line"
				init-with="p:[tr:scale(0), tro:left center]"
				on-init="t-enter"
				on-enter="p:[transform:scale(0):scale(1):500:easeOutQuart]"></div>
			<div class="bot-right border-line"
				init-with="p:[tr:scale(0), tro:right center]"
				on-init="t-enter"
				on-enter="p:[transform:scale(0):scale(1):500:easeOutQuart]"></div>
