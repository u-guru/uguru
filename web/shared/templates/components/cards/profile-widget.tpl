    ...
    <div class="pf-aside-widget"
        ...
        on-enter="p:[background:rgba(99#112#116#0.3):delay-700]">
            ...
            <!-- Ex.1 Positive LINEAR (default) stagger every 500ms, linear [uncommented below]
                ...
                ^^ the plus is optional AND implied

                Total duration: 500 * #_CHILDREN_WITH_ATTR=draw-border-frame]
            -->

            <!-- <stagger-children on-enter="[draw-border-frame]:500"> -->
            <!-- Ex 2. Reverse LINEAR (default) stagger every 500ms
                <stagger-children on-enter="[draw-border-frame]:-500">
                Total duration: 500 * #_CHILDREN_WITH_ATTR=draw-border-frame]
            -->
            <!-- Ex 3. Total duration w/ easing
                Reverse EASEOUTCIRC stagger with total DURATION 5000ms (#of children doesnt matter, the magic activates them in order)
                <stagger-children on-enter="[draw-border-frame]:2000:easeOutCirc">
            -->
            <!-- Ex 4. Total duration w/ REVERSE easing
                Reverse EASEOUTCIRC stagger with total DURATION 5000ms (#of children doesnt matter, the magic activates them in order)
                <stagger-children on-enter="[draw-border-frame]:2000:-easeOutCirc">
            -->
