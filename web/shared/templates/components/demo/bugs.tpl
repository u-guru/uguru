	...
	<ul class="flex-wrap-center p15-grid">
		...
		<li>
			<div class="bg-auburn flex-center width-128 height-128 radius-2"
				...
				<h1 class="txt-14 semibold txt-center">bounceIn-subtle<br/>separate opacity</h1>
			</div>
		</li>
		...
		<li>
			<div class="bg-auburn flex-center width-128 height-128 radius-2"
				...
				<h1 class="txt-14 semibold txt-center">various properties</h1>
			</div>
		</li>

		<li>
			<div class="relative width-128 height-128 flex-center">
				<svg class="fill-auburn absolute top-0 left-0 width-128 height-128" viewBox="0 0 128 128">
