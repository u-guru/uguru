...
<div id="pyramid"
	...
	<div class="playing-card-container">
		<div class="playing-card play-heart c1"
			...
			when-grid-init="p:[transform:rotateY(90deg) rotateX(-29deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):600:easeOutExpo, left:280px:15px:600:easeOutExpo, top:136px:-35px:600:easeOutExpo]"
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(-29deg) translateZ(0px):400:easeOutQuad, left:15px:280px:400:easeOutQuad, top:-35px:136px:400:easeOutQuad]:delay-1400"
			when-column-init="p:[transform:rotateY(0deg) translateZ(0px):rotateY(0deg) translateZ(300px):600:easeOutExpo, left:15px:245px:600:easeOutExpo, top:-35px:-35px:600:easeOutExpo, tro:50% 50% -300px]">
		...
		<div class="playing-card play-heart c2"
			...
			when-grid-init="p:[transform:rotateY(90deg) rotateX(29deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):600:easeOutExpo, left:282px:130px:600:easeOutExpo, top:136px:-35px:600:easeOutExpo]:delay-100"
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(29deg) translateZ(0px):400:easeOutQuad, left:130px:282px:400:easeOutQuad, top:-35px:136px:400:easeOutQuad]:delay-1300"
			when-column-init="p:[transform:rotateY(0deg) translateZ(0px):rotateY(72deg) translateZ(300px):600:easeOutExpo, left:130px:245px:600:easeOutExpo, top:-35px:-35px:600:easeOutExpo, tro:50% 50% -300px]:delay-100">
		...
		<div class="playing-card play-heart c3"
			...
			when-pyramid-init="p:[transform:rotateY(0deg) rotateX(90deg) translateZ(24px):rotateY(90deg) rotateX(90deg) translateZ(0px):400:easeOutQuad, left:0px:204px:400:easeOutQuad, top:0px:268px:400:easeOutQuad]:delay-2400"
			when-grid-init="p:[transform:rotateY(90deg) rotateX(90deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):600:easeOutExpo, left:204px:245px:600:easeOutExpo, top:268px:-35px:600:easeOutExpo]:delay-200"
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(90deg) translateZ(0px):400:easeOutQuad, left:245px:204px:400:easeOutQuad, top:-35px:268px:400:easeOutQuad]:delay-1200"
			when-column-init="p:[transform:rotateY(0deg) translateZ(0px):rotateY(144deg) translateZ(300px):600:easeOutExpo, left:245px:245px:600:easeOutExpo, top:-35px:-35px:600:easeOutExpo, tro:50% 50% -300px]:delay-200">
		...
		<div class="playing-card play-heart c4"
			...
			when-pyramid-init="p:[transform:rotateY(0deg) rotateX(90deg) translateZ(22px):rotateY(90deg) rotateX(-29deg) translateZ(0px):400:easeOutQuad, left:0px:204px:400:easeOutQuad, top:0px:268px:400:easeOutQuad]:delay-2200"
			when-grid-init="p:[transform:rotateY(90deg) rotateX(-29deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):600:easeOutExpo, left:204px:360px:600:easeOutExpo, top:268px:-35px:600:easeOutExpo]:delay-300"
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(-29deg) translateZ(0px):400:easeOutQuad, left:360px:204px:400:easeOutQuad, top:-35px:268px:400:easeOutQuad]:delay-1100"
			when-column-init="p:[transform:rotateY(0deg) translateZ(0px):rotateY(216deg) translateZ(300px):600:easeOutExpo, left:360px:245px:600:easeOutExpo, top:-35px:-35px:600:easeOutExpo, tro:50% 50% -300px]:delay-300">
		...
		<div class="playing-card play-diamond c5"
			...
			when-grid-init="p:[transform:rotateY(90deg) rotateX(29deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):600:easeOutExpo, left:208px:475px:600:easeOutExpo, top:268px:-35px:600:easeOutExpo]:delay-400"
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(29deg) translateZ(0px):400:easeOutQuad, left:475px:208px:400:easeOutQuad, top:-35px:268px:400:easeOutQuad]:delay-1000"
			when-column-init="p:[transform:rotateY(0deg) translateZ(0px):rotateY(288deg) translateZ(300px):600:easeOutExpo, left:475px:245px:600:easeOutExpo, top:-35px:-35px:600:easeOutExpo, tro:50% 50% -300px]:delay-400">
		...
		<div class="playing-card play-diamond c6"
			...
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(-29deg) translateZ(0px):400:easeOutQuad, left:15px:352px:400:easeOutQuad, top:130px:268px:400:easeOutQuad]:delay-900"
		...
		<div class="playing-card play-diamond c7"
			...
			when-grid-init="p:[transform:rotateY(90deg) rotateX(29deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):600:easeOutExpo, left:356px:130px:600:easeOutExpo, top:268px:130px:600:easeOutExpo]:delay-200"
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(29deg) translateZ(0px):400:easeOutQuad, left:130px:356px:400:easeOutQuad, top:130px:268px:400:easeOutQuad]:delay-800">
		...
		<div class="playing-card play-diamond c8"
			...
			when-pyramid-init="p:[transform:rotateY(0deg) rotateX(90deg) translateZ(14px):rotateY(90deg) rotateX(90deg) translateZ(0px):400:easeOutQuad, left:0px:130px:400:easeOutQuad, top:0px:400px:400:easeOutQuad]:delay-1400"
			when-grid-init="p:[transform:rotateY(90deg) rotateX(90deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):600:easeOutExpo, left:130px:245px:600:easeOutExpo, top:400px:130px:600:easeOutExpo]:delay-300"
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(90deg) translateZ(0px):400:easeOutQuad, left:245px:130px:400:easeOutQuad, top:130px:400px:400:easeOutQuad]:delay-700">
		...
		<div class="playing-card play-club c9"
			...
			when-grid-init="p:[transform:rotateY(90deg) rotateX(90deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):600:easeOutExpo, left:281px:360px:600:easeOutExpo, top:400px:130px:600:easeOutExpo]:delay-400"
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(90deg) translateZ(0px):400:easeOutQuad, left:360px:281px:400:easeOutQuad, top:130px:400px:400:easeOutQuad]:delay-600">
		...
		<div class="playing-card play-club c10"
			...
			when-grid-init="p:[transform:rotateY(90deg) rotateX(-29deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):600:easeOutExpo, left:130px:475px:600:easeOutExpo, top:400px:130px:600:easeOutExpo]:delay-500"
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(-29deg) translateZ(0px):400:easeOutQuad, left:475px:130px:400:easeOutQuad, top:130px:400px:400:easeOutQuad]:delay-500">
		...
		<div class="playing-card play-club c11"
			...
			when-grid-init="p:[transform:rotateY(90deg) rotateX(29deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):600:easeOutExpo, left:134px:15px:600:easeOutExpo, top:400px:295px:600:easeOutExpo]:delay-200"
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(29deg) translateZ(0px):400:easeOutQuad, left:15px:134px:400:easeOutQuad, top:295px:400px:400:easeOutQuad]:delay-400">
		...
		<div class="playing-card play-club c12"
			...
			when-grid-init="p:[transform:rotateY(90deg) rotateX(-29deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):600:easeOutExpo, left:280px:130px:600:easeOutExpo, top:400px:295px:600:easeOutExpo]:delay-300"
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px:rotateY(90deg) rotateX(-29deg) translateZ(0px)):400:easeOutQuad, left:130px:280px:400:easeOutQuad, top:295px:400px:400:easeOutQuad]:delay-300">
		...
		<div class="playing-card play-spade c13"
			...
			when-grid-init="p:[transform:rotateY(90deg) rotateX(29deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):600:easeOutExpo, left:282px:245px:600:easeOutExpo, top:400px:295px:600:easeOutExpo]:delay-400"
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(29deg) translateZ(0px):400:easeOutQuad, left:245px:282px:400:easeOutQuad, top:295px:400px:400:easeOutQuad]:delay-200">
		...
		<div class="playing-card play-spade c14"
			...
			when-grid-init="p:[transform:rotateY(90deg) rotateX(-29deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):600:easeOutExpo, left:428px:360px:600:easeOutExpo, top:400px:295px:600:easeOutExpo]:delay-500"
			when-grid-pyramid--init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(-29deg) translateZ(0px):400:easeOutQuad, left:360px:428px:400:easeOutQuad, top:295px:400px:400:easeOutQuad]:delay-100">
		...
		<div class="playing-card play-spade c15"
			...
			when-grid-init="p:[transform:rotateY(90deg) rotateX(29deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):600:easeOutExpo, left:430px:475px:600:easeOutExpo, top:400px:295px:600:easeOutExpo]:delay-600"
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(29deg) translateZ(0px):400:easeOutQuad, left:475px:430px:400:easeOutQuad, top:295px:400px:400:easeOutQuad]">
