...
<!-- <div id="pyramid" class="absolute perspective-container flex-center opacity-25p" style="width:600px; height:600px; top:10%; left:50%; margin-left:-300px;">
...
<div id="pyramid" class="absolute perspective-container" style="width:600px; height:600px; top:50%; left:50%; margin-left:-300px; margin-top:-300px; -webkit-perspective-origin: 50% 30%; perspective-origin: 50% 30%;"
	...
	<div class="playing-card-container">
		...
		<div class="playing-card play-heart c3"
			...
			when-grid-init="p:[transform:rotateY(90deg) rotateX(90deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):400:easeOutQuad, left:204px:245px:400:easeOutQuad, top:268px:-35px:400:easeOutQuad]:delay-200">
		...
		<div class="playing-card play-heart c4"
			...
			when-grid-init="p:[transform:rotateY(90deg) rotateX(-29deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):400:easeOutQuad, left:204px:360px:400:easeOutQuad, top:268px:-35px:400:easeOutQuad]:delay-300">
