...
<div id="pyramid" style="-webkit-perspective: 2000; perspective: 2000; -webkit-perspective-origin: 50% 50%; perspective-origin: 50% 50%;"
	...
	<div class="playing-card-container">
		<div class="playing-card play-heart c1"
			...
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(-29deg) translateZ(0px):400:easeOutQuad, left:15px:280px:400:easeOutQuad, top:-35px:136px:400:easeOutQuad]:delay-2800">
		...
		<div class="playing-card play-heart c2"
			...
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(29deg) translateZ(0px):400:easeOutQuad, left:130px:282px:400:easeOutQuad, top:-35px:136px:400:easeOutQuad]:delay-2600">
		...
		<div class="playing-card play-heart c3"
			...
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(90deg) translateZ(0px):400:easeOutQuad, left:245px:204px:400:easeOutQuad, top:-35px:268px:400:easeOutQuad]:delay-2400">
		...
		<div class="playing-card play-heart c4"
			...
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(-29deg) translateZ(0px):400:easeOutQuad, left:360px:204px:400:easeOutQuad, top:-35px:268px:400:easeOutQuad]:delay-2200">
		...
		<div class="playing-card play-diamond c5"
			...
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(29deg) translateZ(0px):400:easeOutQuad, left:475px:208px:400:easeOutQuad, top:-35px:268px:400:easeOutQuad]:delay-2000">
		...
		<div class="playing-card play-diamond c6"
			...
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(-29deg) translateZ(0px):400:easeOutQuad, left:15px:352px:400:easeOutQuad, top:130px:268px:400:easeOutQuad]:delay-1800">
		...
		<div class="playing-card play-diamond c7"
			...
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(29deg) translateZ(0px):400:easeOutQuad, left:130px:356px:400:easeOutQuad, top:130px:268px:400:easeOutQuad]:delay-1600">
		...
		<div class="playing-card play-diamond c8"
			...
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(90deg) translateZ(0px):400:easeOutQuad, left:245px:130px:400:easeOutQuad, top:130px:400px:400:easeOutQuad]:delay-1400">
		...
		<div class="playing-card play-club c9"
			...
			when-pyramid-init="p:[transform:rotateY(0deg) rotateX(90deg) translateZ(12px):rotateY(90deg) rotateX(90deg) translateZ(0px):400:easeOutQuad, left:0px:280px:400:easeOutQuad, top:0px:400px:400:easeOutQuad]:delay-1200"
			when-grid-init="p:[transform:rotateY(90deg) rotateX(90deg) translateZ(0px):rotateY(0deg) rotateX(0deg) translateZ(0px):600:easeOutExpo, left:280px:360px:600:easeOutExpo, top:400px:130px:600:easeOutExpo]:delay-400"
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(90deg) translateZ(0px):400:easeOutQuad, left:360px:280px:400:easeOutQuad, top:130px:400px:400:easeOutQuad]:delay-1200">
		...
		<div class="playing-card play-club c10"
			...
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(-29deg) translateZ(0px):400:easeOutQuad, left:475px:130px:400:easeOutQuad, top:130px:400px:400:easeOutQuad]:delay-1000">
		...
		<div class="playing-card play-club c11"
			...
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(29deg) translateZ(0px):400:easeOutQuad, left:15px:134px:400:easeOutQuad, top:295px:400px:400:easeOutQuad]:delay-800">
		...
		<div class="playing-card play-club c12"
			...
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px:rotateY(90deg) rotateX(-29deg) translateZ(0px)):400:easeOutQuad, left:130px:280px:400:easeOutQuad, top:295px:400px:400:easeOutQuad]:delay-600">
		...
		<div class="playing-card play-spade c13"
			...
			when-grid-pyramid-init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(29deg) translateZ(0px):400:easeOutQuad, left:245px:282px:400:easeOutQuad, top:295px:400px:400:easeOutQuad]:delay-400">
		...
		<div class="playing-card play-spade c14"
			...
			when-grid-pyramid--init="p:[transform:rotateY(0deg) rotateX(0deg) translateZ(0px):rotateY(90deg) rotateX(-29deg) translateZ(0px):400:easeOutQuad, left:360px:428px:400:easeOutQuad, top:295px:400px:400:easeOutQuad]:delay-200">
