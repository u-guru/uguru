...
<grid-view type='row'>
    <grid-item class='bg-charcoal uppercase' width='100' height='40' align='bottom center' margin="5%">
        <grid-item width='50%' align="center center" font-size="64px" class='border-2'>
            <!-- p15xy -->
            <h1 class='full-x weight-700 txt-72 flex-vertical-center'>
                <letter type='squishBounce'>V</letter>
                <letter type='squishBounce'>I</letter>
                <letter type='squishBounce'>B</letter>
                ...
                <letter type='squishBounce'>U</letter>
                <letter type='squishBounce'>B</letter>
            </h1>
        </grid-item>
    </grid-item>
    <grid-item class='bg-slate-20p' width='100' height='20' align='top center'>
        <!-- <grid-item width='100' align='center center' margin="10px">
            <h1 class='full-x weight-500 flex-vertical-center margin-0'>
    ...
    <grid-item class='bg-charcoal' width='100' height='40' align='top center'>
        <grid-item padding='20px 0' width='33' height='15' padding="10%" align='center center'>
        <!-- <grid-item  -->
