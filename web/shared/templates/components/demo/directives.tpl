...
>>>>>>> 4d12daef954a927fd875c806c8c236175dfe9901
		...
		<li init-with="p:[tro:center center]"
			init-after="portal-academic-init"
			on-init="a:[bounceIn-subtle:5000:easeInOutSine:0:1:f]">
			<div class="bg-transparent border-solid border-smoke border-3 p10xy flex-center width-128 height-128 radius-2">
                <h1> init-after from loader </h1>
            </div>
		</li>
        <li init-with="p:[transform:translateY(-500%)rotate(-1080deg)]" init-after="first-tile-parent-init" on-init="a:[translateY:-500%:0%:5000:bouncePast:0:1:f,scale:0:1:5000:linear:0:1:f,rotate:-1080deg:0deg:5000:easeOutQuint:0:1:f]">
            <div class="bg-transparent border-solid border-smoke border-3 p10xy flex-center width-128 height-128 radius-2">
