<div class='flex-vertical-center full-xy absolute left-0 top-0'>
    ...
    <div style='height:20%; width:20%;' class='bg-cerise txt-charcoal flex-wrap-center txt-1 p15-grid' u init-with="prop:[transform:rotateX(180deg)]" on-init="a:[rotateX:180deg:0deg:2500:easeOutExpo:0:1:f]" on-click="a:[rotateX:180deg:0deg:2500:easeOutExpo:0:1:f]">
        <span class='text-center flex-wrap'>
            a:[rotateX:180deg:0deg:2500:easeOutExpo:0:1:f]
        </span>
    </div>
    <div style='height:20%; width:20%;' class='bg-smoke txt-charcoal flex-wrap-center txt-1 p15-grid' u init-with="prop:[background-color:#69B3A5]" on-click="a:[width:0%:12.5%:150:easeOutSine:0:1:f, opacity:0:1:150:easeInSine:0:1:f, background-color:#69B3A5:#99CEFA:150:easeOutSine:0:1:f]">
        <span class='text-center flex-wrap'>
