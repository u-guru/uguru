<div class="full-xy flex absolute full-xy top-0 left-0">
    <ul class="flex-wrap full-x p15-grid" on-init="s:[init-all-scale:public]">
        <li class='full-x' style='height:10%;'>
         ...
         <li class='flex-vertical-center width-20p' ng-repeat='ease in ::root.easings' on-init="s:[activate-children:public]">
            <svg fill="none" init-after="activate-children" init-with="p:[opacity:0]" on-init="p:[opacity:1]"  class="width-128 height-128" viewBox="0 0 128 128">
                ...
                <text text-anchor="middle" x="64" y="84" font-size="32" stroke="none" fill="white" init-after="activate-children" on-init="a:[counter:$0cents:$100cents:5000:{{ease}}:500:1:f, l-progress-color:5000:linear:250:1:f, fill:#69B3A5:#F6C64E:5000:linear:250:1:f]">00
                </text>
