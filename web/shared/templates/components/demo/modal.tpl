    ...
    <main-view>
        <ul class="flex-wrap-center p15-grid">
            <li u on-click='send:[modal-green-tile-requested:public]'>
                ...
                <div id='green-tile' class="relative width-128 height-128 flex-center"
