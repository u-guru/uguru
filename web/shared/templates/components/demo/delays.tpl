    ...
    <ul class="flex-wrap-center p15-grid" on-init="s:[init-all-scale:public]">
        ...
        <li class='m20x'>
            <div class="bg-transparent border-solid border-smoke border-3 p10xy flex-center flex-wrap width-128 height-128 radius-2"
                ...
                init-after="init-all-scale"
                on-init="a:[slideInUp-subtle:2500:linear:0:1:f]">
                <h1 class="txt-azure height-50p weight-900 opacity-50p semibold txt-center full-x">
                    slideInUp-subtle
                </h1>
                <ul class='full-x flex-wrap-center txt-azure weight-500 grid'>
        ...
        <li class='m20xy'>
            <div class="bg-transparent border-solid border-smoke border-3 p10xy flex-center flex-wrap width-128 height-128 radius-2"
                init-with="p:[transform:scale(0)]"
                init-after="init-all-scale"
                on-init="a:[slideInUp-subtle:2500:linear:1000:1:f]">
                <h1 class="txt-azure height-50p weight-900 opacity-50p semibold txt-center full-x">
                    slideInUp-subtle
                </h1>
                <ul class='full-x flex-wrap-center txt-azure weight-500 grid'>
        ...
        <li class='m20xy'>
            <div class="bg-transparent border-solid border-smoke border-3 p10xy flex-center flex-wrap width-128 height-128 radius-2"
                init-with="p:[transform:scale(0)]"
                init-after="init-all-scale"
                on-init="a:[slideInUp-subtle:2500:linear:0:1:f]:delay-1000">
                <h1 class="txt-azure height-50p weight-900 opacity-50p semibold txt-center full-x">
                    slideInUp-subtle
                </h1>
                <ul class='full-x flex-wrap-center txt-azure weight-500 grid'>
        ...
        <li class='m20xy'>
            <div class="bg-transparent border-solid border-smoke border-3 p10xy flex-center flex-wrap width-128 height-128 radius-2"
                init-with="p:[transform:scale(0)]"
                init-after="init-all-scale"
                on-init="a:[slideInUp-subtle:2500:linear:500:1:f]:delay-500">
                <h1 class="txt-azure height-50p weight-900 opacity-50p semibold txt-center full-x">
                    slideInUp-subtle
                </h1>
                <ul class='full-x flex-wrap-center txt-azure weight-500 grid'>
        ...
        <li class='m20xy'>
            <div class="bg-transparent border-solid border-smoke border-3 p10xy flex-center flex-wrap width-128 height-128 radius-2"
                init-with="p:[transform:scale(0)]"
                init-after="init-all-scale"
                on-init="a:[slideInUp-subtle:2500:linear:250:1:f]:delay-750">
                <h1 class="txt-azure height-50p weight-900 opacity-50p semibold txt-center full-x">
                    slideInUp-subtle
                </h1>
                <ul class='full-x flex-wrap-center txt-azure weight-500 grid'>
