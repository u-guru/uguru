	...
	<ul class="card-house p15-grid flex-wrap-center"
		...
		<li init-with="p:[op:0, tro:center center, t:all 500ms ease-out]"
			...
			<div class="team-card-container team-gabrie"
				...
				when-house-return="p:[transform:rotateY(90deg) rotateX(-31deg) translateX(-5px) translateY(4px) translateZ(10px) rotate(0deg):rotateY(0deg) rotateX(0deg) translateX(0px) translateY(0px) translateZ(0px) rotate(0deg):1000:easeOutSine]:delay-300">
				<a></a><a></a><a></a><a></a>
				<div class="team-card-placeholder"
					init-with="p:[z-index:-1]"
					when-house-rotate="p:[display:none]:delay-3000">
					<div class="front"></div>
					<div class="back"></div>
				</div>
					...
					<div>
						<div class="team-link"
							...
							<div class="team-icon"
								...
								<svg class="gabrie-front" viewBox="0 0 200 200">
								    <g class="gabrie-guru" fill="none" fill-rule="evenodd">
										<path d="M103.574667,101.347451 C99.5891604,101.700595 98.2136606,103.933569 98.3857487,104.176455 C99.4389701,105.656063 100.262491,107.336058 100.791631,109.181043 C103.295147,117.913236 98.2459966,127.022376 89.5138811,129.526779 C80.7808023,132.030373 71.6716623,126.981222 69.1672601,118.249107 C67.5744394,112.693202 62.199641,113.00992 62.199641,113.00992 L62.0757398,109.645196 C62.0757398,109.645196 64.3423669,109.048822 66.9589013,107.320448 C69.7727831,105.460564 72.9707958,102.441588 73.5525427,101.878377 C75.4279684,100.064896 77.7624199,98.6726953 80.4458954,97.9032938 C86.1323387,96.2722764 91.978569,97.8448642 96.0568783,101.551765 C96.234315,101.712963 97.5871447,99.2208686 103.344546,98.7171612 C108.659071,98.2522005 110.424096,100.471518 110.570845,100.281958 C113.943499,95.9231818 119.427835,93.359298 125.311111,93.978096 C128.087424,94.2698279 130.628163,95.2355046 132.790005,96.6957706 C133.460714,97.1494056 137.134381,99.5671879 140.228479,100.910191 C143.105392,102.15795 145.441143,102.351669 145.441143,102.351669 L145.903402,105.686789 C145.903402,105.686789 140.555262,106.308207 139.951412,112.056296 C139.001374,121.090636 130.907398,127.644864 121.872249,126.695788 C112.837909,125.745749 106.283681,117.651774 107.232834,108.617511 C107.433556,106.708671 107.952838,104.911196 108.733128,103.271177 C108.860425,103.002098 107.11807,101.041901 103.13179,101.386198 L103.574667,101.347451 L103.574667,101.347451 L103.574667,101.347451 L103.574667,101.347451 L103.574667,101.347451 Z M86.70313,127.841647 C94.0409571,127.19967 99.4690164,120.730761 98.8270397,113.392934 C98.185063,106.055107 91.7161539,100.627048 84.3783268,101.269024 C77.0404997,101.911001 71.6124404,108.37991 72.2544171,115.717737 C72.8963938,123.055564 79.3653029,128.483624 86.70313,127.841647 L86.70313,127.841647 L86.70313,127.841647 L86.70313,127.841647 L86.70313,127.841647 Z M124.347679,124.548176 C117.009852,125.190152 110.540942,119.762093 109.898966,112.424266 C109.256989,105.086439 114.685048,98.6175297 122.022875,97.975553 C129.360703,97.3335763 135.829612,102.761636 136.471588,110.099463 C137.113565,117.43729 131.685506,123.906199 124.347679,124.548176 L124.347679,124.548176 L124.347679,124.548176 L124.347679,124.548176 L124.347679,124.548176 Z" class="glasses" stroke="#2B3234" stroke-linecap="round" stroke-linejoin="round" fill="#2B3234"></path>
										<path d="M127.129799,90.1720275 C124.476761,81.5355025 125.920692,84.0145413 123.231927,79.1203282 C123.677287,84.2108138 123.553283,86.8209675 122.887975,90.5431391 C115.731334,90.9199327 105.273493,91.8463491 98.0106748,92.7196208 C77.4606576,95.190528 58.4754771,100.477405 60.2449761,97.5744916 C60.2471429,54.1620262 141.677927,54.2162584 144.823891,90.174796 C144.823891,90.174796 134.127883,89.9725564 127.129799,90.1720275 L127.129799,90.1720275 Z" class="bangs" stroke="#D5AEA6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="#2B3234"></path>
									</g>
								</svg>
							</div>
							<h1 class="team-name"
						...
						<div class="team-info">
							<div init-with="p:[op:0, tr:translateZ(0) translateY(-50px)]"
		...
		<li init-with="p:[op:0, tro:center center, t:all 500ms ease-out]"
			...
			<div class="team-card-container team-jeselle"
				...
				when-house-return="p:[transform:rotateY(-90deg) rotateX(-31deg) translateX(-5px) translateY(4px) translateZ(10px) rotate(0deg):rotateY(0deg) rotateX(0deg) translateX(0px) translateY(0px) translateZ(0px) rotate(0deg):1000:easeOutSine]:delay-400">
		...
		<li init-with="p:[op:0, tro:center center, t:all 500ms ease-out]"
			...
			<div class="team-card-container team-jason"
				...
				when-house-return="p:[transform:rotateY(90deg) translateX(30px) translateY(-5px) translateZ(0px) rotateX(0deg) rotate(0deg):rotateY(0deg) translateX(0px) translateY(0px) translateZ(0px) rotateX(0deg) rotate(0deg):1000:easeOutSine]:delay-500">
				<div class="team-card-placeholder" style="position: relative; top: auto; left: 0; width: 256px; height: 359.5px">
					<div class="front"></div>
					<div class="back"></div>
				</div>
		...
		<li init-with="p:[op:0, tro:center center, t:all 500ms ease-out]"
			...
			<div class="team-card-container team-samir"
				...
				when-house-return="p:[transform:rotateY(-90deg) translateX(-30px) translateY(-5px) translateZ(0px) rotateX(0deg) rotate(0deg):rotateY(0deg) translateX(0px) translateY(0px) translateZ(0px) rotateX(0deg) rotate(0deg):1000:easeOutSine]:delay-600">
				<div class="team-card-placeholder" style="position: relative; top: auto; left: 0; width: 256px; height: 359.5px">
					<div class="front"></div>
					<div class="back"></div>
				</div>
