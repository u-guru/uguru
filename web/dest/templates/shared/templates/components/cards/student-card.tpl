			...
			<div class="school-id-bottom">
				<div>
					<h1 class='lettercase' style="color: #003262;"
						...
						on-init="t-enter"
						on-enter="a:[bounceIn-subtle:set:(dur:1000ms#func:linear):in:delay-150]">Marco Polo</h1>
					<h2 style="color: #003262;"
						init-with="p-op"
						on-init="t-enter"
						on-enter="a:[fadeIn:set:(dur:800ms#func:ease-in):in:delay-150]">Cal Freshman</h2>
					<h2 style="color: #003262;"
						init-with="p-op"
						on-init="t-enter"
						on-enter="a:[fadeIn:set:(dur:800ms#func:ease-in):in:delay-150]">email@school.edu</h2>
				</div>
				<h3>
					<span style="color: #003262;"
						init-with="p-op"
						on-init="t-enter"
						on-enter="a:[fadeIn:set:(dur:800ms#func:ease-in):in:delay-150]">SELECTED COURSES</span>
					<span style="background: #003262;"
						init-with="p:[op:0, tro:left center]"
						on-init="t-enter"
						on-enter="a:[bounceIn-rotate-subtle:set:(dur:1000ms#func:linear):in:delay-350]">9</span>
					<a
						init-with="p-op"
						on-init="t-enter"
						on-enter="a:[fadeIn:set:(dur:800ms#func:ease-in):in:delay-150]">Edit</a>
				</h3>
			</div>
		</div>
	</div>
