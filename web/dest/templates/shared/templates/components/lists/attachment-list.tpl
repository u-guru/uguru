			...
			<li>
				<a>
					<span>
						<svg viewBox="0 0 100 100">
							<g stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
								<rect stroke="white" fill="white" fill-opacity="0.25" x="14" y="14" width="72" height="72" rx="2"></rect>
				...
				<a>
					<span>
						<svg viewBox="0 0 100 100">
							...
							<g fill="none" stroke-linecap="round" stroke-linejoin="round">
								<rect x="14" y="14" width="72" height="72" rx="2" stroke="white" stroke-width="2" fill="white" fill-opacity="0.25"></rect>
			...
			<li>
				<a>
					<span>
						<svg viewBox="0 0 100 100">
						    <g stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
								<path d="M78.6753247,69.4038462 L83.9946012,69.4038462 C85.6544371,69.4038462 87,68.0615005 87,66.4025609 L87,25.0012853 C87,23.3437212 85.6551641,22 83.9983762,22 L22.6769485,22 C21.0191974,22 19.6821402,23.3349726 19.6906437,25.0005709 L19.7282873,32.3739316" stroke="white" fill="white" fill-opacity="0.25"></path>
								<rect stroke="#40484b" fill="#40484b" x="15" y="33" width="63" height="50" rx="3"></rect>
								<rect stroke="white" fill="white" fill-opacity="0.25" x="15" y="33" width="63" height="50" rx="3"></rect>
