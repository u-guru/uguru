	...
	<ul class="pf-rating rating-stars" data-rating="4" data-half="true">
		<stagger-children on-enter="[rating]:600:easeOutCirc">
			<li rating class="rating"
				init-with="p:[op:0, tr:scale(0) rotate(-90deg)]"
				on-init="t-enter"
				on-enter="p:[opacity:0:1:300:easeOutSine, transform:scale(0) rotate(-90deg):scale(1) rotate(0deg):500:easeOutBack easeOutExpo]">
