				...
				<button class="btn-split">
					<span init-with="p:[op:0, tro:right center]"
						...
						<span init-with="p:[op:0, t:opacity 500ms ease-in-out]"
							when-credit-tile-init="p:[op:1:delay-1000]">Get Started</span>
					</span>
					<span init-with="p:[op:0, tro:left center]"
						when-credit-tile-initr="a:[split-button:set:(dur:1000ms#func:linear):in:delay-800]]">
						<span init-with="p:[op:0, t:opacity 500ms ease-in-out]"
							when-credit-tile-init="p:[op:1:delay-1000]">$40</span>
					</span>
				</button>
			</li>
		</ul>
