<grid-view class='bg-azure' type='row'>
    <grid-item  height='10'  align="center left" width='100' class='bg-transparent'>
        <grid-item align='center right' width='25' height='100' class='bg-transparent'>
        ...
        <grid-item align='center center'  width='50' height='100' class='bg-charcoal-20p'>
            <ul class='flex full-xy flex-grow txt-2 uppercase'>
        ...
        <grid-item align='center right' width='25' height='100' class='bg-charcoal-50p'>
            <h1 class='flex-grow text-center'> Become a member </h1>
    ...
    <grid-item class='bg-charcoal-20p' fixed height='10' align-self="bottom right" align="center center" width='10' class='bg-transparent'>
    ...
    <grid-item layer="-1" align="center left" width='100' height='100' absolute class='bg-auburn'>
        <grid-item align='center right' width='25' height='100' class='bg-transparent'>
            <graphic class='flex-grow svg-stroke-5 stroke-cerise fill-cerise' height='50' src='shared/templates/components/svg/main/heart.html'> </graphic>
            <h1 class='flex-grow text-center'> Become a member </h1>
        </grid-item>
