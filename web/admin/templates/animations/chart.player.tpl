<div class='full-x flex' style='height:65px;'>
    <ul class='flex-vertical-center p15-grid'>
        <li ng-click='player.stepBack(player.schedule)'>
        ...
        <li class='relative' style='height:49px; width:47px;'>
            <span player-control ng-click="player.play(player)" class='flex-center svg-32 svg-stroke-6 radius-2 stroke-white' on-click="p:[display:none]|s:[play-click:public]" init-with="p:[display:block]" when-paused-click="p:[display:block]"  ng-class="{'opacity-50p':player.state.active}"  ng-include='"shared/templates/components/svg/main/play.html"'></span>
            <span player-control ng-click='player.pause($event)' id='pause-element' class='flex-center svg-32 svg-stroke-6 radius-2 stroke-white' init-with="p:[display:none]" when-play-click="p:[display:block]" on-click="p:[display:none]|s:[paused-click:public]"  ng-include='"shared/templates/components/svg/main/pause.html"'></span>
        </li>
        <li ng-click='player.reset(player)'>
        ...
        <li ng-click='player.stepForward(player.schedule)'>
        ...
        <li class='flex-vertical-center' style='width:150px !important'>
            <span class='block txt-center relative p15x-p10y weight-900 txt-white txt-20 bg-campus-50p radius-2 width-128'>
                ...
                <span class='txt-1 opacity-60p'>/&nbsp;&nbsp;{{player.playerProps.duration}}ms</span>
            </span>
        </li>
    </ul>
    ...
    <div class='flex-vertical-center relative flex p30right' style="width:calc(100% - 353px)">
        <div class='relative full-x flex-vertical-center height-50p' style="width:calc(100% - 30px)">
            <a ng-click='player.jumpFromClick(player, $event)' class='full-x'>
